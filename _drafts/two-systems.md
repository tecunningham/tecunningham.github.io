...
* I can spot ungrammatical sentences, but I cannot explain why they are ungrammatical.

* I can recognize a drawing of my cousin, but I could not draw her.

* I can recognize patterns in data, but I cannot write an algorithm to detect the same patterns. (Note: Artificial Intelligence was replaced by Machine Learning because we can’t explain to computers what we do automatically.)

## EXAMPLES OF PERCEPTUAL BIASES

* Objects look darker when next to lighter objects

* Large objects feel lighter

* Blue objects look more distant
...
* **Reproducibility of research.** asdf

## SOME FACTS ABOUT HUMAN JUDGMENT

* **Biases in factual questions.**
