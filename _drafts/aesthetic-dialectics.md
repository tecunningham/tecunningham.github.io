---
layout: post
title: Some Aesthetic Dialectics
---

A common pattern:

1. some aesthetic feature is dictated by function,
2. then that feature comes to be used even when it's not dictated, because it has come to seem attractive by association or by custom,
3. then the feature gets exaggerated, so that it could never be mistaken for serving the original purpose.
...
1. Buildings soften and crumble with age;
2. Yale splashes their buildings with acid to make them seem older;
3. Every garden gets a grotto and a ruin.
