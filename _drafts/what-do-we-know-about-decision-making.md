...
* (history: bold conjecture: Lucas; Becker)

* The behavioural debate: (1) K&T and Thaler finding solid examples; (2) journal of regulatory issues 'what we always were doing'; (3) Cochrane, Levine, Landsburg repudiate behavioral - but there is a similarity in their arguments, esp Landsburg: making fun of people whose logic is mistaken, w/o looking for what their real motivations areLandsburg: “Most of economics can be summarized in four words: 'people respond to incentives'. The rest is commentary.”. (4) .

## Accuracy of the benchmark model.

* **Discount factor.** (Frederick and O'Donoghue (2002, JEL)):

* **Labour supply.** Chetty (2012) plots of estimates of intensive margin labour supply elasticities (ignore the red bars):

* **Risk aversion.** (a) Coefficient of relative risk aversion implied by consumption growth: around 1 (Chetty (2009)); (b) coefficient of relative risk aversion implied by the equity premium: around 80 (Mehra and Prescott (1994); (c) coefficient of relative risk aversion implied by aversion to risk in small gambles: around 30,000 (Rabin (2000)).

* **Demand elasticities.** Some surveys find considerable variation in demand elasticities. For example Greene (2010) "How Consumers Value Fuel Economy: A Literature Review”, surveys 25 studies on response to fuel economy of cars, and finds wide variation in estimated values, and no signs of convergence among the better-run studies. This indicates that even well-run studies of demand elasticity are not reliable.

* **We already know the answers.** Studying decision-making in humans is not like studying decision-making in other animals: from everyday life each of us already has decades of observation, and we can test new predictions on ourselves. Because of this, progress in the study of decision-making is often summarized by a list of thought experiments, which each person can apply to themselves, and so learn something about their own decision-making.E.g., Smith's “diamond and water” paradox; Savage's gambles; Allais' gambles; Ellsberg's gambles; Kahneman and Tversky's many decision-sets; Rabin's gambles. Similarly, new theories of decision-making are often proposed as organizing existing observations, rather than making new testable predictions.The same applies to fields such as human perception, logic, or linguistics: many of their theories are self-explanatory without systematic experimentation (e.g., the laws of perspective, the syllogism, or laws of syntactic structure), and progress in each field is often summarized with simple thought experiments -- e.g. optical illusions, invalid logical arguments, or sentences which are grammatical or not.
...
**areas where human judgment is very accurate:** (1) in perception we can make very powerful inferences, and have little insight into the rules we useImportant points: (1) we can learn quite complicated rules; (2) we have poor introspection into those rules; (3) we learn rules, we don't just remember examplars.; (2) even in the domain of abstract logical games - where computers excel - humans can still outperform computers - e.g. in playing Go; (3) medical diagnoses.

**areas where human judgment is very inaccurate.** (1) many studies of judgment find low test-retest reliability, and sensitivity to irrelevant factors; (2) certain classic trick questions, where people jump to give an intuitive-but-wrong answerE.g., the Linda problem; the bat-ball and lily-growth problems; dominated gambles.; (3) large parts of human life which seem to be based on seeing patterns where there are none: astrology; homeopathy; sensing subtle differences in wine, coffee, or music fidelity; parts of religion, and parts of diet or health;It may be that people don't take these judgments very seriously, or that they serve an important social function, independent of their instrumental purpose.Also see book Poulton (1992) “Bias in Quantifying Judgments”, review by Birnbaum “Should Contextual Effects in Human Judgment be Avoided?” .
