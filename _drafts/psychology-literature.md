...
* *learning w/o awareness*: e.g., pair a light with an electric shock, and check for both skin-conductance learning and conscious learning.Mitchell (2009) “The results consistently show evidence for skin conductance CRs only in participants who are aware of the CS-US contingencey ... [a]lthough there are many papers arguing for unaware conditioning, close inspection reveals, in almost all cases, that the measure of conditioning was most likely more sensitive than that of awareness.”- Iowa gambling task- Perruchet (1985): subjects learn that a tone sometimes precedes a puff of air. But eye blink expects positive autocorrelation, and conscious reports expect negative autocorrelation. Discussed in Mitchell (2009) & they seem to believe it.
...
* **1866s: Helmholtz:** perception must require interpreting the signals under some assumptions, “unconscious inference.” (unbewusster Schluss).Note: he mainly meant the unconscious inference to refer to how we learn associations, i.e. we learn a, and he was opposed to school of thought that this is innate.Especially: sensations do not resembles objects, like a key imprinted on wax. Instead they are “signs”, like a signature represents a person.Pylyshyn: “Helmholtz, as well as most vision researchers in the 1950s through the 1970s, assumed that this was inference from knowledge of the world because the inversion was almost always correct (e.g., we see the veridical 3-D layout even from 2-D pictures). ”Adelson: Helmholtz has generally been represented as believing in “high-level” inference, i.e. we use all our knowledge
...
– Wei & Stocker (2012, NIPS) “Efficient coding provides a direct link between prior and likelihood in perceptual Bayesian inference”They explicitly say that they're interested in explaining biases, and they add to the Bayesian model by imposing neural noise.They derive a Bayesian contrast effect from efficient coding: sensitivity is decreasing in density around prior. Result: the bias is proportional to the slope of the prior, so positive bias in neighborhood of decreasing prior. Very surprising! They have an analytic result (given some simplifications), but not trivial to follow.The main result is that the bias is proportional to the slope of the prior. Given some \theta_{0}, then bias is defined as (I think):b(\theta_{0})   =   \int F^{-1}(\tilde{\theta})L(\tilde{\theta})d\tilde{\theta}-F^{-1}(\tilde{\theta}_{0})which is I think just this:b(\theta_{0})=E[\hat{\theta}_{MSE}|\theta_{0}]-\theta_{0}[p5 has a discussion of internal vs external noise, and say that you won't get contrast effects for external noise, not clear why (but they don't discuss correlated noise)][Note that they say they're working within Bayesian perception; but actually they're imposing an additional constraint, so people are imperfeclty bayesian (i.e,. constrainedly bayesian)]
...
– Series, Stocker & Simoncelli (2009, Neural Computation) “Is the Homunculus 'Aware' of Sensory Adaptation?”- Adaptation effects: (1) repulsive bias only in neighborhood of adapter; (2) lower discriminability either side of the adapter.“prolonged exposure to a visual stimulus of a particular orientation, contrast, or direction of movement induces a systematic bias in the estimation of the orientation (Gibson & Radner, 1937; Clifford, 2002), contrast (Hammett, Snowden, & Smith, 1994), or direction (Levinson & Sekuler, 1976) of subsequent stimuli. Adaptation also profoundly modulates the perceptual discrimination performance of these same variables (Regan & Beverley, 1985; Clifford, 2002).”- They assume gain *reduction* for neurons adapted to the stimulus. Note that elsewhere they assume the opposite to get repulsive biases.- “we find that this simple encoder is qualitatively compatible with psychophysically measured biases and discriminability, but only when the decoder is unaware of the adaptation”.- They find (I think) that when they give the model enough power to fit the discriminability data, the bias is essentially zero. p3297 they use 100 neurons in their baseline model, but p3283: they get a quantitatively OK bias with 6 neurons (bias goes in the wrong direction, because tuning curves weaker in adapted direction).
...
– phoneme restoration effect : if you obscure a phoneme, people don't notice, & fill it in with expected phoneme
...
4. “Helmholtz noticed that if he gently pushed on his eye with his finger while trying to maintain fixation on a stationary scene, the scene appeared to move. However, if he let his eye scan the scene, the scene appeared to remain stationary.”

5. Helmholtz: press on the outside edge of your eye, & you see a spot of light coming from the bridge of your nose.
...
* **Barrett & Kurzban (2006, Psych Review) “Modularity in Cognition: Framing the Debate”**
    ...
    * Classic example: Cosmides's 1989 proposal of a cheater-detection system, based on the Wason card task.
    * “language is perhaps the prototypical example of a putatively modular system (Chomsky, 1965; Fodor, 1983). In recent years, many additional modular systems have been proposed, including theory of mind (Baron-Cohen, 1995; Leslie, 1994; Scholl & Leslie, 1999); spatial orientation (Hermer & Spelke, 1996); number (Dehaene & Cohen, 1995); intuitive mechanics (Leslie, 1994; Spelke, Breinlinger, Macomber, & Jacobson, 1992); fear, disgust, jealousy, and other emotion systems (Buss, 1992; Ohman & Mineka, 2001; Rozin, Haidt, & McCauley, 2000); kin detection (Lieberman, Tooby, & Cosmides, 2003); and face recognition (Duchaine, Yovel, Butterworth, & Nakayama, 2004; Kanwisher, 2000).”
    * “some endorse the view that empirical demonstration of top-down or horizontal effects ... are inconsistent with modularity.” They discuss McGurk, and say that modularity can be thought of in a broader way.
    * Q: what is relation of *their* modularity to neural-net style modularity?- “Rozin, Millman and Nemeroff (1986) showed that people who are offered fudge molded to resemble feces are reluctant to eat it as compared with a control condtion in which the same fudge is in a different form.”- “The existence of evolutionarily novel skills, even potentially 'modularized' skills such as driving, chess, or reading, is consistent with the view that all modules have an evolutionary origin.”
...
(AKA induced associations / “cue recruitment” / “contingent adaptation aftereffects” / “associative learning”)

Two separate issues: (i) can you learn without awareness of the stimuli; (ii) can you have knowledge you don't have access to. 

1. Perceptual Learning

(a) “Howells’ (1944) experiment in which people learn to associate a particular tone with the color red after several thousand trials, and then are transferred to a task where they try to identify a neutral color white. When the tone is present, people systematically choose as white a color that is slightly green, suggesting that the tone has come to substitute for redness to some extent.”

(b) McCollough (1965) / “McCollough effect”Staring at a horizontal red grille makes a subsequent horizontal black grille look greenish, & vice versa. Can last several days.“Learning in the McCollough effect appears to be limited to specific signals such as orientation and spatial frequency that are known stimulus features for early visual coding ”Subsequently aclled, more generally, “pattern-contingent color aftereffects”

(c) Garcia, J. & Koelling, R. A. (1966) Psychon. Sci. 4, 123–124.Rats learn to associate illness with flavors more easily than illness with certain lights or sounds.

(d) Kanizsa (1969)Visual illusions not taking into account global information (I think).“As Kanizsa (1985) and Kanizsa and Gerbino (1982) have persuasively argued, these principles do not appear to reflect a tendency for the simplest description of the world and they are insensitive to knowledge, expectations, and even to the effects of learning (Kanizsa 1969).”

(e) Mayhew & Anstis (1972)If you see a disk spinning clockwise under red light, then a stationary disk, under red light, will appear to precess. – effect lasting several days

(f) Dodwell & Humphrey (1990) “A functional theory of the McCollough effect.”McCollough is after-effect of grids. Essentailly an interpretation of contrast effects: “based on the concept of contingent adaptation level, following Helson (1964), and on the "error-correcting device" of Andrews (1964), which tracks and adjusts internal representation to external-world contingencies. ”

(g) Goldstone (1998, Ann Rev Psych) “Perceptual Learning”Survey. Not so useful.

(h) Adams (2004) “experience can change the light-from-above prior”

(i) [kording2004bayesian]: Subjects feel a force, then have to exert an equal opposite force. Experiment finds that subjects adapt to the distribution of possible forces, learned over time. Interpret as Bayesian integration.

(j) Boakes (2005) “Persistence of Acquired Changes in the Properties of Odors and Flavors for Both Humans and Rats”Seems to be a nice review article. Associating a flavour with another flavour causes assimilation. They find that it gets very long-lasting effects. THEY EVEN GET ORDER EFFECTS. “participants show little explicit recall of what odor went with which taste or which other odor. ”

(k) Haijing (2006) “Demonstration of cue recruitment”GOOD DISCUSSION OF LITERATURE ON POSITIVE & NEGATIVE ASSOCIATION EFFECTS.They get *positive* effect from inducing a cue, which is not usual. (Cue was either (i) top/bottom position; (ii) motion; (iii) sound)Subjects see a rotating necker cube, plus disambiguiating cue (e.g. stereo vision), plus an arbitrary cue. Arbitrary cues were top/bottom of screen, and direction of drift of image (they also tried sound, but it didn't work). They note that it's good to do cue recruitment on “perceptually bistable” phenomena, because you're more likely to see effect (easier to push).They explain why they get positive effect, instead of negative: “we would associate negative aftereffects with recalibration and positive aftereffects with changes in signal utilization.”

(l) [flanagan2008experience]Finds that, when you induce an association between a material and some weight, you get anti-bayesian illusions: i.e., when you expect something to be heavy, it feels lighter, all else equal. (Even works if you reverse the typical association: associate larger size with lightness, and then larger things will seem heavier, all else equal).

(m) Ernst (2008) “Perceptual Learning: Inverting the Size–Weight Illusion”You can reverse the size-weight illusion if you induce the opposite associations (i.e., give them heavy-small objects, will start reporting small objects to be lighter)

* Subliminal / Unaware / Unconscious Perception

– Merikle, Smilek, Eastwood (2001, Cognition) “Perception without awareness: perspectives from cognitive psychology”- Overview – they say that the evidence for perception w/o awareness is very strong (mostly using very short flashes).- Q: what is typical outcome variable?

– Pessiglione (2008, Neuron) “Subliminal Instrumental Conditioning Demonstrated in the Human Brain”- They flash a symbol then mask it, and subjects choose gambles. Performance improves, i.e. they learn association, however subjects say they don't perceive it. (They don't seem to engage deeply in the critical literature on subliminal perception).

## Category Learning

- **peak shift principle.** "If a rat is taught to discriminate a square from a rectangle (of say, 3:2 aspect ratio) and rewarded for the rectangle, it will soon learn to respond more frequently to the rectangle. Paradoxically, however, the rat’s response to a rectangle that is even longer and skinnier (say, of aspect ratio 4:1) is even greater than it was to the original prototype on which it was trained.""

– Shepard, Hovland, and Jenkins (1961) “Learning and memorization of classifications,”Classical study of how well people can learn categorization rules, using these stimuli:Different types of classification. They find difficulty of I<II<III,IV,V<VI.

– Kitzis, Kelley, Berg, Massaro, Friedman (1998) “Broadening the Tests of Learning Models”- They use a literature-standard medical diagnosis task: you observe symptoms, and have to predict diagnosis - but broaden the parameters - and find that people are pretty good at it.- “The most striking finding is that the model that best predicts subjects' behavior is a simple Bayesian model with a single fitted parameter for prior precision to capture individual differences.” [i.e., people are pretty good - parametric models are not good.]- [Dan Friedman is coauthor!]

– Townsend (2000) - Discriminate between good guys & bad guys, by distorted faces- Categorize (good/bad) then decide (attack/withdraw)

– Ashby & Maddox (2005, Ann Rev Psych) “Human Category Learning”- GOOD REVIEW. Main result is that there seem to be multiple types, which come out in different paradigms. Best for me is learning what weights to put on continuous cues.- (1) Rule-based (RB): amnesiacs are bad at this; it is disrupted by cognitive load or short time; but is not disrupted by presentation context. (rule-based learning is defined by people using a procedure which can be verbally articulated)- (2) Information integratino (II) - integrate different cues: amnesiacs can learn this; not disrupted by cognitive load or timing; is disrupted by varying the context (e.g., change the response mode, or change the feedback style), and by delaying the feedback. - (3) Prototype learning (i.e., recognise a distorted pattern of dots): people with lots of damage can do this (i.e., recognise A vs not-A), and it seems to be implemented in the early visual system.- (4) Probabilistic learning (e.g., the “weather forecasting” task). 

– Ashby & Maddox (2011, Ann NY Academy Science) “Human Category Learning 2.0”- Rule-based vs Information-Integration tasks: “delaying feedback by a few seconds, switching the location of the response keys, or informing participants of the category label before the stimulus rather than after the response all interfere with performance in II tasks much more than in RB tasks. In contrast, adding a secondary (dual) task or reducing the time available to process the feedback interferes with performance in RB tasks much more than in II tasks. No single-system account of all these dissociations has been proposed.”- “II learning is disrupted by feedback delays just as predicted by reinforcement learning”- II accuracy: “accuracy in II tasks requires several thousand trials to asymptote.” “in many studies of automaticity, asymptotic accuracy is perfect, and as a result the primary focus is on response time (RT)”- once either RB or II tasks are learned, they become automatic: “both show no dual-task interference and they both show a response-key switch interference.”- in RB category learning, providing feedback about errors allows faster learning than providing feedback about correct responses

– (people are very good at learning and judging frequencies of stimuli - mentioned in book by Robin H)

– (people are also extraordinarily good at recognizing whether they had seen a picture before - including low-level details, not just semantics of picture)
...
* **Pascal (c. 1662)** "The heart has its reasons which reason knows nothing of... We know the truth not only by the reason, but by the heart."
    - (He was arguing in part *against* Descartes' elevation of reason)
...
* **Leibniz 1704** "In 1704, Gottfried Wilhelm Leibniz developed a systematic doctrine that both allowed for and made reference to implicit memory (Leibniz, 1916). He emphasized the importance of "insensible" or "unconscious" perceptions: ideas of which we are not consciously aware, but which do influence behavior. Leibniz explicitly claimed that people may have "remaining effects of former impressions without remembering them," and that "... often we have an extraordinary facility for conceiving certain things, because we formerly conceived them, without remembering them" (19?6, p. 106). 

* **1779 Mesmer** Competition with Gassner.[& a general 19th century interest in hypnotism ]

* **1817: Jane Austen, “Persuasion”** ()John Mullan in LRB 2014: Two instances of Austen using unconscious to mean you have a desire of which you're not aware; previously it had meant just to do something unintentionally. Coleridge first used “the unconscious” in 1817 also.From Mansfield Park: Thomas Bertram can't help perceiving that a rich suitor shows interest in his niece, and “nor perhaps refrain (though unconsciously) from giving a more willing assent to invitations on that account’.”

* **1840: Darwin**: emotions as serving some other purpose.
...
* **Neitzsche**
    * He talks (in the Gay science, I think) about the “mirror” - observing our own consciousness; see a paper by a guy at BU about Nietzsche on the unconscious (also discusses Schopenhauer a little). Nietzsche also talks about how consciousness is a later addition onto animal instincts, and has a distorted view of those instincts.
    * from The Gay Science
        * 11: consciousness
        * 44: “The Believed Motive. However important it may be to know the motives according to which man kind has really acted hitherto, perhaps the belief in this or that motive, and therefore that which mankind has assumed and imagined to be the actual mainspring of its activity hitherto, is some thing still more essential for the thinker to know. For the internal happiness and misery of men have always come to them through their belief in this or that motive, not however, through that which was actually the motive! All about the latter has an interest of secondary rank.”
        * 333: “For a very long time conscious thinking was regarded as the only thinking: it is now only that the truth dawns upon us that the greater part of our intellectual activity goes on unconsciously and unfelt by us”

* **Korsakoff 1889** Schacter: he observed that amnesiacs could respond in ways they've learned, without conscious recognition of learning it. “We notice that a whole series of traces which could in no way be restored to consciousness, neither actively nor passively, continue to exist in unconscious life, continue to direct the course of ideas of the patients, suggesting to him some or other inferences and decisions. That seems to me to be one of the most interesting peculiarities of the disturbance about which we are speaking. (p. 518) “

* **Sidis 1898 The Psychology of Suggestion: A Research into the Subconscious Nature of Man and Society**
    - http://djm.cc/library/The_Psychology_Of_Suggestion_Sidis.pdf

* **19th century psychologists:** Mark Altschule: "It is difficult—or perhaps impossible—to find a nineteenth-century psychologist or psychiatrist who did not recognize unconscious cerebration as not only real but of the highest importance."[21]

* **William James (1890) “Principles of Psychology”** Talks a lot about unconscious things. 

* **Jones (1908, Jnl Abn Psych) Rationalization in Every-day Life**
    * Quite short. Makes a distinction between decisions we can give a reason for, and those we cannot. He says the latter are obviously due to some subconscious process - and most of what Freud studies are those. So he considers the former class. Describes justifications for oneself as “evasions”, and justifications for the public as “rationalizations.” Example of evasion: you are brought up by Baptists, but then you defend it as a logical conclusion of the evidence. - Example of rationalization: use of valerian as treatment for hysteria, just because that was used in the past.
    * “[Freud] has shewn with convincing precision that a number of previously incomprehensible mental processes, such as dream formation and certain apparently meaningless and accidental happenings of daily life, are throughout to be explained by regarding them as problems of feeling. He has further shewn that the causes of these mental processes are usually not only unsuspected by the individual concerned, but are repudiated and denied by him when the very existence of them is suggested.”
    * “If for instance he is asked why he wears a stiff collar or a tie, he will certainly regard the question as being extremely foolish, though if he is in an indulgent mood he may humour one to the extent of giving some imaginary explanation, such as "to keep warm," "to look respectable," etc. It is quite plain that he does so only to please the inquirer, and to his mind the real and final explanation of the act lies in its obviousness. The fact that he regards the question as to the origin of the mental process as essentially absurd is evidently because he considers there is no need to search for a cause in an action that he likes to think is volitional, i.e., self-caused.”
    * “we may say that whenever an individual considers a given process as being too obvious to permit of any investigation into its origin and shews resistance to such an investigation, we are right in suspecting that the actual origin is concealed from him — almost certainly on account of its inacceptable nature. Reflection shews that this criterion applies to an enormous number of our fixed beliefs — religious, ethical, political and hygienic, as well as to a great part of our daily conduct:”
    * “The matter once settled he then maintains that he has become convinced of the truth of his doctrine by the overwhelming force of the evidence in its favour, and is highly offended if one bluntly says that he believes in Baptism simply because his father did, and he passionately denies this true but inacceptable explanation.”
    * “It will be an interesting question for the future to determine how many of our most firmly held opinions in the value of universal suffrage, of representative government, of marriage, institutions, etc., are not similar examples of blind acceptance of the suggestive influence of our environment, fortified by the most elaborate evasions and rationalisations.”
    * “[e]veryone feels that as a rational creature he must be able to give a connected, logical and continuous account of himself, his conduct and opinions, and all his mental processes are unconsciously manipulated and revised to that end.”” [quote from CFS]

* **Claparede 1911** :Schacter: Claparede described the now famous example of an amnesic woman who refused to shake hands with him after he pricked her with a pin, even though she did not explicitly remember that Claparede had done so. 

* **Henri Bergson 1911**: Schacter: “The past survives under two distinct forms: first, in motor mechanisms; secondly, in independent recollections”

* **Morton Prince (1914)** “The Unconscious” -- “In normal life ideas of buried experiences of which we have no recollection intrude themselves from time to time and shape our judgments and the current of our thoughts without our realizing what has determined our mental processes. We have forgotten the source of our judgments, but this forgetfulness does not affect the mechanism of the process.” (quoted in Schacter, p. 68)

* **Freud & Breuer *Studies in Hysteria*** - Anna O. 
* ~1900 published papers on the 'seduction theory': most of his patients had represeed memories of childhood sexual abuse. Later decided that these were largely made-up, & instead moved to Oedipal theory, where imagination dreams up these things.

* **Freud (1915) "The Unconscious"** [short essay -- see PDF with collected works of Freud]
    - says the repressed is a *subset* of the unconscious
    - distinguishes between "topological" and "functional" definition of unconscious. "Freud clearly favors the functional model for its appreciation of some apparent peculiarities of unconscious thought: its indifference to temporal order, its lack of negation, the fluid way in which it condenses and displaces contents, and its inability to distinguish psychic reality from external reality... "
...
* **Freud (1925)**
    * Three different books on different ways of getting at subconscious: (1) dreams; (2) jokes; (3) mistakes / slips of the tongue. (Wikipedia: “Jacques Lacan considered it one of the three key texts for an understanding of the unconscious, alongside The Interpretation of Dreams (1900), and Jokes and their Relation to the Unconscious (1905).[3] Sometimes called the Mistake Book (to go with the Dream Book and the Joke Book),[4] the work became one of the scientific classics of the 20th century.[5]”)
    ...
    * psychopathology of everyday life: Mostly mistakes: mishearings, mis-spoken, forgetting, doing the wrong thing, rather than expression through decision-making.
    * “On another occasion, when about to buy a railroad ticket on the Reichenhall Station, I could not recall the very familiar name of the next big railroad station which I had so often passed. I was forced to look it up in the time-table. The name was Rosehome (Rosenheim). I soon discovered through what associations I lost it. An hour earlier I had visited my sister in her home near Reichenhall; my sister's name is Rose, hence also a Rosehome. This name was taken away by my "family complex.””
    * “A woman who is very anxious to get children always reads storks instead of stocks.”
    * “when I walk through the streets of a strange city during [p. 120] my vacation ... I ... read antiquities on every shop sign that shows the slightest resemblance to the word; this displays the questing spirit of the collector.”
...
* **Popper on Freud & Adler:** “‘I personally do not doubt that much of what they say is of considerable importance, and may well play its part one day in a psychological science which is testable.” 

* Gramsci - Cultural Hegemony ()

* **Thorndike & Rock (1934)** “Learning without awareness of what is being learned or intent to learn it. "a satisfying aftereffect could strengthen the connection which it followed and to which it belonged in cases where the learner did not know what the connection was" Experiment 1: word association; they were rewarded if their word is a word which commonly follows the stimulus, and penalized if the word is semantically related. Subjects slowly learned, and they take the slowness of adjustment as evidence of implicitness. Experiment 2: subjects put their hand under the table, and had to mark a point above the table where there hand was. The rewards were biased: more likely to get a reward if you mark a point North-West of the true point.[Also similar experiments in Thorndike's book on learning]

* **Lazarus & McCleary 1949** “Autonomic Discrimination without Awareness” subjects shown nonsense syllables (flashed quicker than they could notice), and sometimes shocked. Subjects are uncomfortable when shown syllables associated with shocks, but cannot pick out which syllables are associated with shocks. [cited by Polanyi][not a good study to cite, because it's more about subliminal perception: they flash things quickly, and compare autonomic response to identification ability; subsequent studies criticized it because it's a coarse measure of discrimination ability]

* **Maslow 1943** “A Theory of Human Motivation”
    * Hierarchy of needs: self-actualization > esteem > love/belonging > safety > physiological.
    * Assumes that needs are basically unconscious: “These needs are neither necessarily conscious nor unconscious. On the whole, however, in the average person, they are more often unconscious rather than conscious. It is not necessary at this point to overhaul the tremendous mass of evidence which indicates the crucial importance of unconscious motivation. It would by now be expected, on a priori grounds alone, that unconscious motivations would on the whole be rather more important than the conscious motivations. What we have called the basic needs are very often largely unconscious although they may, with suitable techniques, and with sophisticated people become conscious.”
    * “A desire for an ice cream cone might actually be an indirect expression of a desire for love. If it is, then this desire for the ice cream cone becomes extremely important motivation. If however the ice cream is simply something to cool the mouth with, or a casual appetitive reaction, then the desire is relatively unimportant. Everyday conscious desires are to be regarded as symptoms, as [p. 393] surface indicators of more basic needs.”

* **Greenspoon (1955) “The reinforcing effect of two spoken sounds on two responses”**
    * "Greenspoon (6) concluded that presenting a stimulus such as "umm-hmm" after plural verbal responses increased the frequency of plural responses. Upon questioning at the conclusion of the experiment, it was found that most of the Ss were unaware of this increase.” [Beautiful description of it here, he was trying to show that therapists could influence their patients unintentionally: http://garfield.library.upenn.edu/classics1982/A1982NP20300001.pdf]

* **Irwin, Kaufman, Prior & Weaver (1934) “On "learning without awareness of what is being learned."**
    * They criticize Thorndike & Rock: they identify implicit learning through gradual response; but even when you tell people they do not get a perfect response. (But at the end of the experiment, when subjects have plenty of time, they get 100% right)

* **Shepard et al. (1961) “Learning and Memorization of Classifications”**
    * stimuli on 3 dimensions, so 8 possible stimuli, sorted into 2 categories; potentially complicated structure to learn. Mostly study the curves of how hard it is to learn each type of categorization. (see above)

*** Chomsky (1965)** “Aspects of the Theory of Syntax”
    * Obviously, every speaker of a language has mastered and internalized a generative grammar that expresses his knowledge of his language. This is not to say that he is aware of the rules of the grammar or even that he can become aware of them.”[His later work seems to deny that you should call it knowledge at all.]

* **Polanyi (1966) “the Tacit Dimenson”** (100 page book)- brief definition: “we know more than we can tell"
    * examples: “We know a person's face ... yet we usually cannot tell how we recognize a face we know.” “We recognize the moods of a human face, without being able to tell, except quite vaguely, by what signs we know it.”
    * gives examples of scientists, artists & clinicians- he has a complicated definition of tacit knowledge: functional, phenomenoal, semantic, and ontological aspects.
    * he ends on the application to science: paradox in Plato's Meno, how can we look for answer to a question without knowing it? Solve this problem by tacit knowledge.
    * and says “The declared aim of modern science is to establish a strictly detached, objective knowledge ... [b]ut suppose that tacit thought forms an indispensable part of all knowledge, then the ideal of eliminating all personal elements of knowledge would, in effect, aim a the destruction of all knowledge.”

* **Fodor (1968) “The Appeal to Tacit Knowledge in Psychological Explanation”**
    * Defending intellectualist (propositional) accounts of thought, and that it's legitimate to ascribe tacit knowledge to an organism. Ryle attacked the intellectualist/propositional school because (1) some things we just do without thought; and (2) some things we can do without being able to explain them. So Fodor says Ryle is right, but these are properly cases of tacit knowledge.
    * Fodor's defence: we have propositional knowledge that is tacit. (1) p631: argument that our visual system uses cues in ways that we are not aware off (quite well put); (2) it makes sense to describe this processing of information as an application of knowledge.
    * He defines tacit knowledge: “If X is something that an organism knows how to do but is unable to explain how to do, and if S is some sequence of operations, the specification of which would constitute an answer to the question “How do you X?,” and if an optimal simulation of the behavior of the organism X-s by running through the sequence of operations specified by S, then the organism tacitly knows the answer to the question “How do you X?,” and S is a formulation of the organism's tacit knowledge.” [I think I have a much better definition - his relies on verbalisation, and 'optimal simulation'].

* **Slovic et al. (1972)**
    * “reported a correlation of only 0.34 between the implicit and explicit weights of 13 professional stockbrokers performing a stock selection task.” Newell & Shanks: “It is quite possible that judges have good insight, but that experimenters have not provided them with sufficient opportunities to report the knowledge that they possess. It is also possible that judges confuse questions about the “importance” of cues for the task environment with their “importance” for their own judgment process”

* **Quine (1972) “Methodological reflections on current linguistic theory”**
    * He makes the point that two different sets of rules can be extensionally equivalent, and so is against saying we have implicit knowledge of particular rules: “the behavior is not guided by the rule unless the behaver knows the rule and can state it.” ... “If it is to make any sense to say that a native was implicitly guided by one system of rules and not by another extensionally equivalent system, this sense must link up somehow with the native's dispositions to behave in observable ways in observable circumstances.” **good point!**
    * **My response:** There's still a sensible sense in which this knowledge is unconscious -- i.e. *whether you can answer counter-factual questions about your judgments*. Applied to grammaticality of sentences, the counterfactual *is* the fact, so less clear. But you can ask about *generalizations*. Can the speaker answer questions about the domain of judgment. E.g., (1) can you swap the order of these two adjectives? -- people say the sentence out loud & see if it works; (2) given two lists of adjectives, which words from list A can go in front of list B, and vice versa -- people will answer in O(n^2) time. 

* **Brewer (1974) “There is no convincing evidence for operant or classical conditioning in adult humans.”**
    * Argues that, in general, most cases of implicit knowledge can be revealed to be explicit with more careful questioning.
    * “all the results of the traditional conditioning literature are due to the operation of higher mental processes, as assumed in cognitive theory, and that there is not and never has been any convincing evidence for unconscious, automatic mechanisms in the conditioning of adult human beings”
    * “A careful demonstration of unconscious, automatic, conditioning would simply become an interesting but relatively insignificant fact about learning in human beings. In fact, given that Homo sapiens evolved from much simpler organisms and that the lower brain centers still function, it would seem strange if human beings showed no unconscious, automatic learning at all”

* **Trivers**
    * Dawkins: “unusually, he chose the medium to announce to the world a brilliant new idea, his theory of the evolution of self-deception.” (in the foreword to the Selfish Gene, 1976)
    * Trivers on self-deception: “Trivers, pursuing his theory of the emotions to its logical conclusion, notes that in a world of walking lie detectors the best strategy is to believe your own lies. You can’t leak your hidden intentions if you don’t think they are your intentions. According to his theory of self-deception, the conscious mind sometimes hides the truth from itself the better to hide it from others. But the truth is useful, so it should be registered somewhere in the mind, walled off from the parts that interact with other people.”
    * Trivers on self-deception: “we know that processes of self-deception—active misrepresentation of reality to the conscious mind—are an everyday human occurrence, that struggling with one’s own tendencies toward self-deception is usually a life-long enterprise, and that at the level of societies (as well as individuals) such tendencies can help produce major disasters (e.g., the U.S. war on Viet Nam).”


* **Nisbett & Wilson (1977) “Telling More than we can know”** [7000 citations] “Subjects are sometimes (a) unaware of the existence of a stimulus that importantly influenced a response, (b) unaware of the existence of the response, and (c) unaware that the stimulus has affected the response.” Both a survey plus some new experiments:
    * Memorizing “ocean-moon” made it more likely subjects would say “Tide” when asked for a detergent. When asked why they said Tide, they gave irrelevant reasons.
    * When ranking quality of garments, tend to favor that on the right-hand side, but never mentioned this as a reason.
    * No relation between strength of anchoring effect and self-report of strength of anchor
    * Watch interview: vary whether person is agreeable, and then rate physical attractiveness and quality of accent. They didn't report being influenced by agreeableness, though they were
    * Three studies where people are *not* influenced by some manipulation, but they say that they are

* **Lewicki (1986, J Exp Psych) “Processing information about covariations that cannot be articulated”**
    * [doesn't seem very strong]Show subjects photos of women & personality descriptions. Either associate long-hair w ability & short-hair w kindness, or the reverse. Then ask about the two attributes for new women. They find an effect on response time: if hair-length is relevant, this affects response time.
    * “Lewicki’s studies involve a training phase where people are exposed to a secret covariation (e.g., between hair length and personality dimensions) under the cover story of learning about other relationships. After training, subjects are tested on new stimuli to see if they rate them higher on a given dimension (e.g., kindness) based on a feature that was covaried with it during training. The consistent finding of this research is that subjects pick up and respond to these covariations without being able to report them.”

* **Rumelhart & McClelland (1986) “On Learning the past tenses of English verbs”**
    * They say that connectionist theories give a precise meaning to implicit knowledge: “may provide a mechanism sufficient to capture lawful behavior, without requiring the postulation of explicit but inaccessible rules” In a later paper “Using knowledge in processing is no longer a matter of finding the relevant information in memory and bringing it to bear; it is part and parcel of the processing itself.” [I think this is the paper that Pinker attacks: they argue that a simple neural net can learn tenses; he says that in fact it does a shitty job]

* **Schachter (1987) “Implicit Memory: History and Current Status”**
    * Definition is a good fit for my theory: “Implicit memory is revealed when previous experiences facilitate performance on a task that does not require conscious or intentional recollection of those experiences; explicit memory is revealed when performance on a task requires conscious recollection of previous experiences. ”

* **Moravec (1988) (Moravec's Paradox)**
...
* **Arthur Reber (1989, J Exp Psych) “Implicit Learning & Tacit Knowledge”**
    * [reber's work started in the mid-70s]Protocol is to show subjects patterns (instances of a grammar, or cards w/ different probability of success). General finding is that people learn the correct patterns, though bad at explaining how the patterns work, and being told about the pattern doesn't help (or harms). “The picture that is emerging ... knowledge acquired from implicit learning procedures is knowledge that, in some fashion, is always ahead of the capability of its possessor to explicate it.” (When their explanations are given to another naive subject, the new subject performs at 50% effectiveness)[there is an argument over whether this learning is abstract or not: a non-abstract interpretation, in Brooks & Vokey (1991) is that subjects just remember a lot of exemplars, and judge by similarity; so I guess knowledge is just too large to explain]
...
* **Bechara, Tranel, Damasio and Damasio (1996) “Failure to respond autonomically to anticipated future outcomes following damage to prefrontal cortex"**
    * Iowa gambling task: you choose between good and bad decks, “healthy participants show a "stress" reaction to hovering over the bad decks after only 10 trials, long before conscious sensation that the decks are bad”... but those with a lesion don't get that stress reaction. Their explanation: “somatic marker hypothesis,”the higher-brain is influenced by emotions generated at lower levels. Evidence from people with lesions, they perform worse at task, & somehow don't learn from skin response.But people don't seem to take it so seriously anymore.

* **Berry (1997) “How Implicit is Implicit Learning?”** (book)
    * [this quote is from a website, I don't even know what experiments that they ran] Argument that people cannot explain their learning: “It was found that in both cases, practice significantly improved ability to control the tasks, but had no effect on ability to answer post-task, written questions. In contrast, verbal instructions about the best way to control the tasks had no significant effect on control performance, although they did make people significantly better at answering the questions. [...] these basic findings have been replicated and extended in a number of follow-on studies” 

* **Kolinsky and Morais (1999)** "pre-literate children and illiterate adults are unable to perform intentional operations at the level of the phoneme while most literate children and ex-illiterates who learned to read and write as adults succeed in these tasks. Lack of phonemic awareness does not prevent the illiterates from being perfectly able to discriminate between pairs of stimuli that differ only in one phoneme or phonetic feature.”

* **Hogarth (2001) “Educating Intuition”**
    * A book (UPF economist, supervisor of Colin Camerer), review of literature.

* **Jimenez (2003) “Attention & Implicit Learning”** (book)

* **Ashby & Casale (2003) “the Cognitive Neuroscience of Implicit Learning”**

* **Cleeremans (2003, Encyc. Cog Sci) “Implicit Learning”**
    * Three main paradigms:(a) artificial grammar (finite state grammar) (b) dynamic system control (sugar factory) (c) sequence learning (performance improves because of correlations in sequencing of stimuli, “— has become dominant in the study of implicit learning”)[see also “multiple cue probability learning”]
    * With sequence learning: you ask people to construct a sequence that obeys the learned rules, and they're good; ask them to construct a sequence that violates it, and they can't do it.

* **Shanks & St John (1994, BBS) "Characteristics of dissociable human learning systems"**
    Two criteria for unconscious knowledge: (1) the same kind of information tested for in awareness and performance; (2) test for conscious awareness must be sufficiently sensitive.

* **Evans, et. al. (2003, Memory & Cognition) Explicit and implicit processes in multicue judgment.** Learn to predict suitability of candidate for job, based on tests. Subjects learn the cues pretty well, but when asked to rate importance of cues, they give different judgments.

* **Lagnado et al. (2006) “Insight and Strategy in Multiple Cue Learning”** Weather prediction task : you observe a playing card, and predict probability of rain. They say that (1) people learn to use the cues optimally; and (2) people are pretty good at explaining their knowledge, and prior interpretations otherwise have somehow been using the wrong test.

* **Persaud (2007, Nature) “Post-Decision Wagering Objectively Measures Awareness”** The idea: first get people to choose, then bet on how likely they are right. If people are unconsciously aware, then they should choose correctly, but not bet on getting it right. (Not a good fit for my model.)

* **Gladwell (2007) “Blink”** "Gladwell gives a wide range of examples of thin-slicing in contexts such as gambling, speed dating, tennis, military war games, the movies, malpractice suits, popular music, and predicting divorce.”[anecdotal examples: recognizing a fake Kouros ; fire lieutenant recognizing when building collapses; Vietnam war game - retired general beat the analysts; ]

* **Hodgkinson (2008) “Intuition: a fundamental construct in the behavioural sciences”** Reviews a lot of different concepts, not much about evidence

* **Sun, Lane & Matthews (2009) “The two systems of learning: An architectural perspective”**
    The introduction has a nice potted history of implicit learning — defensive, because it seems that people are mostly skeptical about existence of implicit learning.

* **Dienes and Seth (2009) “Gambling on the unconscious”**
    Uses incentives: “when people are just as ready to bet on a genuine random process as their own classification decisions, their classiﬁcations are still above baseline, indicating knowledge participants are not aware of having.”

* **Shanks (2010, Ann Rev Psych) “Learning: From Association to Cognition”**
    ∗ Two main conclusions: (a) either associationist or cognitive (inferentialist) models can accommodate many patterns in learning; (b) evidence for learning w/o awareness is not very strong
    ∗ Terminology: Conditioned Stimulus (CS), Unconditioned Stimulus (US), Conditioned Response (CR).Time: “simultaneous”, “delay” (US overlaps with CS), “trace” (US follows CS with gap)
    ∗ Example setups: (has good examples)
    ∗ What patterns in stimuli do people pick up? They find that you get blocking (AB+ causes B+, but not {A+ then AB+}), and other more complicated patterns. Could be interpreted either as inference or association patterns at higher level.

* **Dienes (2010?) “Subjective measures of unconscious knowledge”**
    * Review of how to test for unconscious knowledge. (a) when your guesses are above chance; and (b) when there's low correlation between your , but you claim not to know; (b) structural knowledge: .[Dienes has been pushing for this definition of unconcious knowledge as you being *unaware* that your guesses are informative, but I think it's a separate issue]

* **Mitchell, de Houwer, Lovibond (2009, BBS) “The propositional nature of human associative learning”**
    * They consider Pavlovian learning, not instrumental learning (they think instrumental learning is already proven to be non-associative). They say that most associative learning responds to contingencies in a logical way, implying that it's integrated, not autonomous (against dual systems)
    ...
    * Crucial point: dual-systems interpretation implies “a strong bell-food link may form in the absence of any belief that presentation of the bell signals food delivery.”
    * They say that (1) you don't learn associations if you're not aware of them; (2) Pavlovian learning can learn very complex patterns; (3) you can learn an association just by verbal instruction. They mention some exceptions.
...
* **Paul J. Reber (2013, Neuropsychologia) “The neural basis of implicit learning and memory: A review of neuropsychological and neuroimaging research”**

* **David Autor (2014) “Polanyi's Paradox & the Shape of Employment Growth”**
    - polarization: “tasks that cannot be substituted by computerization are generally complemented by it.”
    - Moravec's paradox / but he thinks that the hard skills are evolved: “Sensorimotor skills, physical flexibility, common sense, judgment, intuition, creativitiy, spoken language, etc., are 'built-in' capabilities that the species evolved rather than developed” [judgment?]
    - “engineers cannot program a computer to simulate a process that they (or the scientific community at large) do not explicitly understand. This constraint is more binding than one might initially surmise because there are many tasks that we understand tacitly and accomplish effortlessly for which we do not know the explicit “rules” or procedures.”
    - “When we break an egg over the edge of a mixing bowl, identify a distinct species of birds based only on a fleeting glimpse, write a persuasive paragraph, or develop a hypothesis to explain a poorly understood phenomenon, we are engaging in tasks that we only tacitly understand how to perform.1”
    - two basic sets of tasks that are difficult to computerize: abstract judgment/creativity/persuasion ; and situational/vision-language/interpersonal
    - “computerization is strongly associated with employment polarization at the level of industries, localities, and national labor markets”- “aftermarket windshield replacement companies employ technicians, not robots, to install replacement windshields” / google car cannot drive on an unfamiliar road /
    - machine learning: instead of telling machines how to do it, we show them by examples
    - “Where engineers are unable to program a machine to 'simulate' a non-routine task by following a scripted procedure, they may nevertheless be able to program a machine to master the task autonomously by studying successful examples of the task being carried out by others.” [e.g. recognizing chairs - not a simple set of physical features ; see Grabner 2011 'what makes a chair a chair?']

* **Chalk, Seitz, Series (2012, J Vision) “Rapidly learned stimulus expectations alter perception of motion”**
    * They show people faintly moving dots, ask them (1) are there dots; (2) which direction are they moving? In the training phase they oversample some directions of motion, and they find that this biases judgments overall.They argue that the experience affects priors, and make a weak case that this knowledge is implicit (just asking people afterwards).“Further, we noted that if the observed estimation biases were due to a change in behavioural strategy, this must have occurred at a largely subconscious level, as most participants were unable to indicate the two motion directions that had been most frequently presented, with a large proportion (9 out of the 12 participants included in our analysis) reporting either that there were equal number of stimuli moving in all directions, or that most of the stimuli were centered around a single motion direction. Also, our personal observations from setting up the experiment is that lab personnel often perceived patterns of moving dots in zero contrast trials, leading us to the conclusion that experimental subjects experienced the same “hallucinations”.” 

* **Paul Reber: (Reber Junior) Sequence learning**
    * http://reberlab.psych.northwestern.edu/2013/04/learning-a-short-timed-motor-sequence/

* **Davies (2015?) “Knowledge - explicit, implicit and tacit: Philosophical aspects”**
    * Has a nice distinction: implicit knowledge can mean things which are implied by what we know, but not explicitly represented (e.g., we know all the cases, but not the general rule; or we know the rule and not the cases). Or it can mean that it is information stored at a different level. He says “the distinction between rule-implicit and rule-implicit systems is quite different from the distinction between explicit storage and implicit representation of information.” E.g., Dennett: “Let us have it that for information to be represented implicitly, we shall mean that it is implied logically by something that is stored explicitly.”

## Philosophers on Tacit Knowldge:

* **Gilbert Ryle on “Knowing What” vs “Knowing How”**

* **Stich (1978) "Beliefs & Subdoxastic States"** 
    - abstract: "it is argued that the intuitively sanctioned distinction between beliefs and non-belief states that play a role in the proximate causal history of belifs is a distinction worth preserving in cognitive psychology. The intuitive distinction is argued to rest on a pair of features exhibited by beliefs but not by subdoxastic states. These are access to consciousness and inferential integration. Harman's view, which denies the distinctino between beliefs and subdoxastic states, is discussed and criticized."

    "If a linguist believes a certain generalization to the effect that no transformation rule exhibits a certain characteristic, and if he comes to (non-subdoxastically) believe a given transformation which violates the generalization, he may well infer that the generalization is false. But merely having the rule stored (in the way that we are assuming all speakers of the language do) does not enable the linguist to draw the inference ... Suppose that for some putative rule, you have come to believe that if r then Chomsky is seriously mistaken. Suppose further that, as it happens, r is in fact among the rules stored by your language processing mechanism. The belief along with the subdoxastic state will not lead to the belief that Chomsky is seriously mistaken. by contrast, if you believe (perhaps even mistakenly) that r, then the belief that Chomsky is seriously mistaken is likely to be inferred."

        “It is characteristic of beliefs that they generate further beliefs via inference. What is more, beliefs are inferentially promiscuous. Provided with a suitable set of supplementary beliefs, almost any belief can play a role in the inference to any other [...] it is in this sense that a person’s beliefs are inferentially integrated” ... “largely inferentially isolated from the large body of inferentially integrated beliefs to which a subject has access” [quoted in Fodor 83, this refers to some kind of implicit knowledge]

* **Evans (1981)** “”Rat vs human belief: “[T]he rat manifests its ‘belief’ in only one way —by not eating— whereas there is no limit to the ways in which the ordinary belief that something is poisonous might be manifested. The subject might manifest it by, e.g., preventing someone else from eating food, or giving it to a hated enemy, or by committing suicide with it” (Evans 1981, p. 131)[note: not actually true, rats also respond to extinction.]

## Associations:

* **Kahneman & Morewedge (2008) “Associative processes in intuitive judgment”** Just some smple stuff about representativeness-type things. 
...
## Inducing new preferences/associations with random pairing

* **Fanselow & Birk (1982) “Flavor-flavor associations induce hedonic shifts in taste associations”**
    * Give rats vanilla+saccharine, and they come to prefer vanilla flavor in other drinks. Also in humans: “. Investigation into conditioned aversions in humans has been limited to anorexia of patients treated for cancer with chemotherapy (3, 11, 33, 89). Bernstein’s research (11) has shown that children undergoing chemotherapy formed aversions to new foods presented after chemotherapy treatments”- Seem to be lots of similar papers online.

## implicit knowledge of languages:

* (Fodor 1983 has some good quotes about this, esp citing Stich: they're talking about how you seem to know grammatical rules, but not in the same way that a linguist knows grammatical rules.)

* Macdonald, C., (ed) (1995). “Tacit Knowledge” in Philosophy of Psychology: Debates on Psychological Explanation

* **Eva M. Fernandez and Helen Smith Cairns, Fundamentals of Psycholinguistics. Wiley-Blackwell, 2011**
...
**Biederman and Shiffrar (1987) “??” on chicken sexing**
    “it is so difficult that it takes years of training (consisting of repeated trials) to become one of the rare experts. ... Beiderman and Shiffrar found that what distinguished good sexers from poor ones is, roughly, where they look and what distinctive features they look for. Although the experts were not aware of it, what they had learned was the set of contrasting features and, even more important, where exactly the distinguishing information was located. This was demonstrated by showing that telling novices where the relevant information was located allowed them to quickly become experts themselves. ”

**Simon (1992)** “The situation has provided a cue: This cue has given the expert access to information stored in memory, and the information provides the answer. Intuition is nothing more and nothing less than recognition”
...
**Grove et al. (2000) “Clinical versus mechanical prediction: A meta-analysis.”** Studies of human health& behaviour. 40% the computer won. 10% the human won (esp. when data includes clinical interview data).

**Koehler, Brenner & Griffin (???) “The Calibration of Expert Judgment: Heuristics and Biases Beyond the Laboratory”**
    Very good survey of many probability-calibration curves. Weather forecasters & bridge players are very well calibrated. In other domains tendency to have base-rate neglect: if low-probability, then systematically over-estimate likelihood ; if high-probability, underestimate likelihood.

**Holley (2009) “How Good Can it Get? Analysing and Improving OCR Accuracy in Large Scale Historic Newspaper Digitisation Programs”**
    No good quote, but says that accuracy significantly lower than human recognition even for typed text. (& even with a dictionary).

**ReCAPTCHA**

* Kahneman and Klein (2009) “Conditions for Intuitive Expertise: A Failure to Disagree”They say judgment is good when (i) there's quick feeback; and (ii) lots of experience.“conclude that evaluating the likely quality of an intuitive judgment requires an assessment of the predictability of the environment in which the judgment is made and of the individual’s opportunity to learn the regularities of that environment. Subjective experience is not a reliable indicator of judgment accuracy.”“A central goal of NDM is to demystify intuition by identifying the cues that experts use to make their judgments, even if those cues involve tacit knowledge and are difﬁcult for the expert to articulate.”

* Mechanisms and neural basis of object and pattern recognition: a study with chess experts

* judgment of personality / stereotypes

– Lee Jussim (2012) “Social Perception & Social Reality”Argues that stereotypes are in fact very accurate (i.e., people pretty good at judging features from demographics)He also has a forthcoming 2014 survey article. “”

* expert judgment: EEG & epilepsy

– “long-term video EEG monitoring can provide 90% positive diagnostic information and it has become the golden standard in epilepsy diagnosis”in “Automatic Detection of Epilepsy EEG Using Neural Networks”

– “Seizure detection and background grading algorithms are a topic of intense ongoing research (e.g. 54, 55 ). Data suggest that accurate seizure detection requires neonatal-specific algorithms, which many investigators are working to develop. 13 However, current commercially-available algorithms have poor sensitivity and specificity.”

– \Rightarrow but all the papers I can find are just comparing it to human judgments as the benchmark, i.e. not against *actual* epileptic fits.

– Seizure prediction competition: increased accuracy a great deal: https://www.kaggle.com/c/seizure-prediction

* expert judgment: auditing

– Nelson & Tan (2005) “Judgment and Decision Making Research in Auditing: A Task, Person, and Interpersonal Interaction Perspective ”Survey. Interesting effects: “sequential processing and order effects (Ashton 12 and Ashton 1988), consistency effects (Tan 1995), justification effects (Cushing and Ahlawat 1996); accountability (Lord 1992; Kennedy 1993), and pre-decisional distortion (Wilks 2002).”.

* expert judgment: soil

– Gaeth & Shanteau (1984) “Reducing the Influence of Irrelevant Information on Experienced Decision Makers”Students have to discriminate between different types of soil, influenced by irrelevant information. (Need to judge ratio of sand/clay/silt in soil).Irrelevant information: coarse fragments and excessive moisture.They find that a lecture is ineffective, but interactive demonstration is effective at debiasing; and even works a year later.

* expert judgment: chess

– DeGroot (1946)First argued for recognition/intuition as determining skill, rather than intellectual power.(i) in think-aloud, stronger players didn't report considering a deeper tree

– Calderwood, Klein & Crandall (1988, AJP) “Time Pressure, skill, and move quality in chess”They found that decrease in quality due to time pressure is less for masters (comparing regular & blitz).

– Saariluoma (1991) : chess masters can remember a random series of moves without problem ; but have great difficulty if it includes illegal moves

– Burns (2004, Psych Science) “The Effects of Speed on Skilled Chess Performance”Ranking in blitz chess (5 minutes for a game) is very close to ranking in long-time chess. And time pressure affects novices relatively more.[but other papers dont' find such supporting evidence]

– irrelevant changes: (1) transpose the two sides of the board / mirror image ; (2) switch black & white (“color flipping”); (3) history-dependence / path dependence.

– other games: computers are still way behind at playing Go ; “Ariima” is a simple logical game that no computer has been able to beat a human at.\Rightarrow computer+human still is significantly better than computer alone.

* artificial intelligence & games:

– 1996: Chinook won world championship at checkers

– 1997: Deep Blue narrowly beat Kasparov in 1997, could evaluate “200 million positions per second” ; search depth 6 - 20 moves ; trained on 700,000 grandmaster games (100 games/day for 20 years)

– 2007: Schaeffer et al. (Science) Checkers Is Solved (they calculated nash equilibrium, it is a draw).

– 2007ish? Watson defeating Jennings and Rutter on Jeopardy!

– 2008: “Polaris won the first meaningful match against professional poker players”

– 2014: Bowling et al., close-to-optimal solution for HULHE (heads-up (2-player) limited-raise texas hold-em)

* weather forecasting

– Stewart, Roebber, Bosart (1997) “The Importance of Task in Analyzing Expert Judgment”“forecasts were highly accurate and forecaster agreement was high ... Human forecasters performed better than an operational forecasting model and about the same as a linear regression model. ” [in temperature & precipitation forecasting]

– Nate Silver (NYT, 2012) “the weatherman is not a moron”“According to the agency's statistics, humans improve the accuracy of precipitation forecasts by about 25 percent over the computer guidance alone. They improve the temperature forecasts by about 10 percent. Humans are good enough, in fact, that when the organization's Cray supercomputer burned down, in 1999, their high-temperature forecasts remained remarkably accurate.”

– Baars (2006) “Performance of national weather service forecasts”
...
– Safavi et al. (2013?) “Identiﬁcation of Gender from Children’s Speech by Computers and Humans”asdf

– Ambady & Rosenthal (1992, Psy Bulletin) “Thin Slices of Expressive Behaviour as Predictors of Interpersonal Consequences: a Meta-Analysis”People can judge others very quickly. However it's not a very satisfying survey. Most important finding is that accuracy in judging something (e.g., are they lying) from watching 30 seconds of muted video is not much lower than any other treatment.- Average correlation between judgment & outcome of .39

– Bruce (1993, Perception) “Sex discrimination: how do we tell the difference between male and female faces?”“People are remarkably accurate (approaching ceiling) at deciding whether faces are male or female, even when cues from hair style, makeup, and facial hair are minimised. “Performance at judging the sex from photographs (with hair concealed) was disrupted if the photographs were inverted, which implies that the superficial cues contributing to the decision are not processed in a purely 'local' way. ”

* Affects vs Cognition

– Zajonc (1980) “Feeling and Thinking: Preferences Need No Inferences”General point: Affective responses are not dependent on cognitive recognition of characteristics - they seem to be prior.Evidence: (a) can get affective response to features you don't consciously identify (esp. prior exposure); (b) reaction time quicker for affective than cognitive judgments; (c) affect is not a simple function of objective features; (d) better recall for things which have affect association; (e) order effects: primacy effect for affect, recency effect for recall.“In contrast with cold cognitions, affective responses are effortless, inescapable, irrevocable, holistic, more difficult to verbalize, yet easy to communicate and to understand”

* Bayesian decision-making

– Gold & Shadlen (2007) “The Neural Basis of Decision-Making”Just a drift/diffusion model of decision-making

– Karelia & Hogarth (2008, ) “Determinants of Linear Judgment: a Meta-Analysis of Lens Model Studies”asdf

– Brunswik's Lens model∗ - Hogarth has a meta-analysis of estimated lens models.- Note Brunswik also discussed depth cues in perception

* Evidence for irrelevant influences on judgment (leakage / context effects / subconscious influences)

– Isen et al. (1978)Your evaluation of a product improves, if you're given a free gift to go with it

– Evans, Barston & Pollard (1983) “”- Acceptance of syllogisms as valid depends on their content: e.g., won't accept “no nutritional things are inexpensive; some vitamin tablets are inexpensive; therefore, some vitamin tablets are not nutritional.”

– Schwarz & clore (1983)Evaluation of life satisfaction is higher on a sunny day than on a rainy day

– Goldin & Rouse (2000)They find that blind audtions in orchestras increases probability of a woman being hired & promoted (though quite weak evidence).

– Brown & Carpenter (2000, J Consumer Research) “Why Is the Trivial Important? A Reasons‐Based Account for the Effects of Trivial Attributes on Choice”Mainly they mean adding some *extra* irrelevant attribute, and not obviously irrelevant, rather 'trivial'. Often results are in joint choice, not separate.

– Lee (2001) “the mere exposure effect”“A meta-analysis by Bornstein (1989) of mere exposure research published between 1968 and 1987 included over 200 experiments examining the exposure-affect relationship. Unreinforced exposures were found to reliably enhance affect toward visual, auditory, gustatory, abstract, and social stimuli.”

– Spence et al. (2010, Chemosensory Perception) “Does Food Color Influence Taste and Flavor Perception in Humans?”- “research findings ... clearly support the view that people’s judgments of flavor identity are often affected by the changing of a food or drink’s color (be it appropriate, inappropriate, or absent).” (but they find ambiguous evidence for the effect of color on the intensity of a flavor – e.g. whether it's more raspberry when it's red.)

– North (2011) “The Effect of Background Music on the taste of wine”
...
– “source monitoring” – information affects your memory even if the source is known to be irrelevant“misinformation effect” – post-event information alters your memory about the original event (e.g., asked if you saw a stop sign).

– Brady (2008) “Visual long-term memory has a massive storage capacity for object details”“Participants viewed pictures of 2,500 objects over the course of 5.5 h. Afterward, they were shown pairs of images and indicated which of the two they had seen. The previously viewed item could be paired with either an object from a novel category, an object of the same basic-level category, or the same object in a different state or pose. Performance in each of these conditions was remarkably high (92%, 88%, and 87%, respectively).”
...
– Maia (2009) “Reinforcement Learning, conditioning, and the brain: successes and challenges”Review article.

– Erev & Halevy (2013?) “Learning & the Economics of Small Decisions”Good review of a lot of learning literature, in econ & psych.they make some generalizations: “Decision makers tend to (1) underweight rare events; (2) explore too much when the number of alternatives is small (exhibit the payoff variability effect); (3) explore too little when the number of alternatives is large (converges to local maximum), and (4) overreact to attractive forgone payoffs.” [that was working-paper version, the published version seems to have slightly different classification.] They propose a model: I-SAW (Inertia, Sampling & Weighting).[criticism: all these biases can be rationalized in some contexts, but will reverse in other contexts] 

– Violation of law of effect: “Tolman (1925) observed an interesting violation of the law of effect in a study of rats’ behavior in a T-maze. Upon receiving a reinforcement in a particular arm, rats tend to switch to the other arm of the maze. According to the common explanation to this spontaneous alternation pattern (see review in Dember & Fowler, 1958), it reflects a tendency to respond to the likely sequential dependencies in natural settings. That is, in most environments where rats eat (e.g., storehouses and garbage dumps) food is replenished independently of feeding. Thus, after eating the food in one location, it is typically optimal to move to a different location. More recent studies use a similar argument to explain probability matching (see Estes, 1976; Sonsino, 1997; Gaissmaier & Schooler, 2008) and underweighting of rare events (Plonsky & Erev, 2013).|

– Gaissmaier & Schooler (2008, Cognition) “The smart potential behind probability matching”Something about .
...
– Wason & Evans (1975) proposed dual systems in reasoning

– Sloman (1996) 

– Stanovich (1999) applies it to individual differences, says people are similar @ system 1, and coined “system 1” / “system 2”

– Osman (2004) criticism

– McClure, Ericson, Laibson, Loewenstein and Cohen (2007) – neural correlates of short-run & long-run desires – many citations

* Sloman (1996) “The Empirical Case for Two Systems of Reasoning”GOOD! I think roughly says that even when making logic or factual judgments, there's strong influence on speed & accuracy from associational things.- says that up til now, there has been a long debate about whether thought is fundamentally associative or rule-based – evidence forces us to think that there are both faculties- principal argument is from contradictory beliefs: “reasoning problem satisfies Criterion S if it causes people to simultaneously believe two contradictory responses. By "believe" I mean a propensity, a feeling or conviction that a response is appropriate even if it is not strong enough to be acted on. ”, e.g. the Linda problem. “the tendency to provide the first response continues to be compelling irrespective of belief in the second answer, irrespective even of certainty in the second answer.”- “response interference in reasoning caused by the intrusion of similarity-based processing.”- “Roughly, one system is associative, and its computations reflect similarity and temporal structure; the other system is symbolic, and its computations reflect a rule structure.”- “ The associative system encodes and processes statistical regularities of its environment, frequencies and correlations amongst the various features of the world. ... Generally speaking, associative systems are able to divide perceptions into reasonable clusters on the basis of statistical (or at least quasi-statistical) regularities. ... associative thought uses temporal and similarity relations to draw inferences and make predictions that approximate those of a sophisticated statistician.”- “applying rules is relatively complex and slow”- “The rule-based system can suppress the response of the associative system in the sense that it can overrule it.”- examples: Linda problem (“Apparently, two mechanisms exist that lead to divergent conclusions. On one hand, an intuitive heuristic leads to the conclusion that T & F is more probable. On the other hand, a probabilistic argument leads to the conclusion that T is more probable”). / Wason card task / - dispersed: “When a response is produced solely by the associative system, a person is conscious only of the result of the computation, not the process ... [t]he result is accessible, but the process is not”

* Against two systems: (Glimcher seems to be against localisation of value computation in the brain, esp McClure-Laibson style)

* Osman (2004) “evaluation of dual process theories”- She considers three problems (1) Wason card selction; (2) Linda problem; (3) syllogisms.- She considers four arguments: (1) criterion S; (2) individual differences; (3) implicit v explicit processing; (4) neuroanatomical differences- Says that most evidence is consistent with continuous single-process processing.- “Evidence used to support dual theories is consistent with single-system accounts.”

* Keren & Schul (2009, Perspectives on Psych Science) “Two Is Not Always Better Than One”- “We propose that the different two-system theories lack conceptual clarity, that they are based upon methodological methods that are questionable, and that they rely on insufficient (and often inadequate) empirical evidence.”- nice discussion of why you might mistrust Criterion-S ; general attack on predictive power.

* Gigerenzer (2011) “???”- “Dual-process theories of reasoning exemplify the backwards development from precise theories to surrogates.”

* Kahneman (2011) “thinking, fast & slow”- asdf

* 2013 debate on Dual Systems (in Persp on Psych Sci)

– Stanovich & Evans “Dual-Process Theories of Higher Cognition: Advancing the Debate”- they prefer “two types“ to “two systems”, because there are multiple early- there are many dichotomies that different theorists have used to define the 2 systems, but these are correlated not defining- type 1 defining features: “does not requre working memory, autonomous”- type 2 defining features: “requires working memory, cognitive decoupling; mental simulation”- “Sloman ... proposed an architecture that has a parallel-competitive form ... our own theories (in common with ... Kahneman) are default-interventionist in structure .... Type 2 processing may or may not intervene ... we disagree ith other aspects of Sloman's account - for example, the conention that simultaneous contradictory belief is a necessary condition for the existence of dual processes in conflict”- conditions for mistakes: “A benign environment is an environment that contains useful cues that, via practice, have been well practiced by Type 1 mechanisms ... In contrast, a hostile environment for Type 1 processing is one in which there are no overpracticed cues that are usable (thus causing the substitution of an attribute only weakly correlated with the true target)”

– Kruglanski “Only One? the Default Interventionist Perspective as Unimodel”- The same facts could be explained with a single system applying successive heuristics- “On closer look, this portrayal of the judgmental process is strikingly similar to the unimodel proposed by Kruglanski and Gigerenzer (2011)”- “Time pressure, cognitive load, and noise reduce individual's cognitive resources ... responses ... gravitate toward the less demanding inference rule based on one's beliefs, prior knowledge, recently primed heuristics, or chronically accessible stereotypes.”

– Osman “A Case Study: Dual Process Theories of Higher Cognition”- The distinctive features of DP theories are regarding the interaction of working memory & working-memory capacity- DP predicts: memory load should have more effect on those with high working memory (those with little WM have already used it up). But this isn't true.- DP predicts: memory load should degrade performance only when S2 is required (“deontic tasks”), but not true.

– Thompson, “Why it Matters: the Implications of Autonomous Processes for DP theories”- She says “autonomy” is the crucial insight into System1 processes

* Josh Greene, “Moral Tribes”Talks about automatic and manual modes of moral thinking. Esp fast & slow reactions on trolley task. We have fast system to deal with .

* Rand, Greene & Nowak (2012, Nature) “Spontaneous Giving and Calculated Greed”Social heuristics Hypothesis: “To explain these results, we propose that cooperation is intuitive because cooperative heuristics are developed in daily life where cooperation is typically advantageous.”

* in discounting:McClure (2013) “towards a general model of temporal discounting”, esp a section on “multiple selves; distinguishes between synchronic & asynchronic models (strategic w.r.t. future self), and discusses evidence for multiple-self decision-making. 

12.1 In neuroscience

* Model free: dorsolateral stratium & dopamine (Daw,Niv, Dayan 2005)Model based: prefronal cortex (Daw, Niv, Dayan 2005)

* [Most common methodology is problem-solving: people have to choose the correct response for a given stimuli, and we investigate (i) ability to ignore distractors; and (ii) ability to control response when stimuli is contingent on some other stimulus or high-level information]

– Miller & Cohen (2001, Ann Rev Neuro) “An Integrative Theory of Prefrontal Cortex Function”Basic idea: earlier system knows a lot of associations (input->output), and PFC selectively suppresses them (“role is modulatory rather than transmissive”)- Stroop task is the canonical case: the PFC has to struggle to inhibit connection from word stimuli to verbal response.- (1) PFC activation corresponds to high-level information about the task: not stimulus, not response, but the combination“relatively few neurons' activity simply reflected a cue or response ... the modal group showed activity that reflected the current assocation between a visual cue and a directional saccade it insutructed ... e.g. a given cell might only be strongly activated when A instructed 'saccade left' [not other stimuli or other responses]”- (2) PFC is wired to most sensory & action areas- (3) PFC damage disrupts learning new patterns (“patients could no longer learn arbitrary associations between visual patterns and hand gestures”)- (4) PFC damage disrupts organisation of activities“the components of a complex behavior are usually left intact, but the subject is not able to coordinate them in a task-appropriate way (for example, a patient who, when preparing coffee, first stirred and then added cream)”- (5) PFC not affected by distractors“survived the presentation of intervening distractors ... the capacity to support sustained activity in the face of interference is one of the distinguishing characteristics of the PFC.”- (6) Reward prediction error activates PFC, i.e. when there is unexpected good/bad news (& so potentially a new contingency that it should look for)- (7) Limited capacity“severely limited capacity”Q: economic applications?

– Daw, Niv & Dayan (2005, Nat Neuro) “Uncertainty-based competition between prefrontal and dorsolateral striatal systems for behavioral control”- it's a purely theoretical paper (I think): two competing models, pure reinforcement (just cache expected reward), vs tree-search, both generate predictions + degree of confidence; choice is made based on prediction + confidence (you could reinterpret it as both systems producing a posterior). They say that tree-based system is always optimal, & the tradeoff is just that it's more complicated to implement, so as a kludge they assume imperfect implementation (they add noise).- motivating fact: when you devalue a reward (e.g., you pre-feed the rat, so it's not hungry; or you poison that type of pellet) then simple (cache-based) reinforcement learning will still seek intermediate outcomes; but tree-based will not seek them.- “A broad range of neural and behavioral data suggests that the brain contains multiple systems for behavioral choice, including one associated with prefrontal cortex and another with dorsolateral stratium”- [striatum does] “'caching': namely, the association of an action or situation with a scalar summary of its long-run future value.” ... “the prefrontal circuit subserves a model-based reinforcement learning method. This constructs predictions of long-run outcomes, not through cached storage, but rather on the fly, by chainging together short-term predictions about hte immediate consequences of each action in a sequence. .... Search in deep trees can be expensive interms of memory and time and can also be error-prone. However, that the predictions are constructed on the fly allows them to react more nimbly to changed circumstances, as when outcomes are re-valued. This ... is the behavioral hallmark of cognitive (or 'goal-directed') control.”- “The conventional idea is that the dorsolateral striatum and its dopaminergic afferents support habitual or reflexive control, whereas prefrontal cortex is associated with more reflective or cognitive action planning.” AND “the classic idea that habitual control is associated with dopamine and dorsolateral striatum, and more cognitive search with prefrontal cortex.”- “a clever behavioral approach to differentiating dual control strategies: namely, conditioning studies in which the values of rewards are unexpectedly changed. Outcome re-evaluation affects the two styles of control differently and allows investigation of the characteristics of each controller, its neural substrates and the circumstances under which it dominates.”- “hybrid ... theories founder on lesion results indicating a dissociation between the neural substrates for tree-like and cache-like choice.”- “Owing to computational costs in tasks involving deep trees, it is commonplace in reinforcement learning to search partway along some paths, then use cached values to substitute for unexplored sub-trees”[interesting, similar to sequential aggregation] - interaction of systems: “Animals can acquire a new conditioned response even for a stimulus whose associated reinforcer had been devalued, suggesting at least the value of the stimulus was cached.”

– Dayan (2011, Lecture) “Interactions Between Model-Free and Model-Based Reinforcement Learning”https://www.youtube.com/watch?v=01z6agTRvOo(1) devaluation & overtraining (ODoherty did it with M&Ms at Caltech)(2) 3 systems: MB, MF, & Pavlovian - he interprets Pavlovian as hardwired; chickens unable to learn that going away from food source gets food (Pavlovian hard-wired)(4) dopamine prediction-errors correlate well with BOLD in ventral striatum(5) Daw tree task: see whether people stick to strategy when the land in the non-congruent state & get a good outcome; mix of MF and MB prediction.Like ordering fish, they accidentally bring you chicken, which is very good; so next time you orde the fish again.(6) Latent learning: subjects first learn structure without rewards, then asked to get rewards.

– Keramati, Dezfouli, Piray (2011) “Speed/Accuracy Trade-Off between the Habitual and the Goal-Directed Processes”- Iranian guys; respectfully cited by Doll, Simon & Daw- Two mechanisms: model-free and model-based RL, both predict future payoffs from an action, but model-based conditions on more information- Lines of evidence for existence of two mechanisms:(1) devaluation works to suppress a response but not if there is overtraining(2) when there are two options with similar values, and one is devalued, then rats quickly learn, even if there is overtraining(3) reaction time increases when you reverse the polarity of a decision (i.e., you need to re-learn)Q: when is the model-based mechanism activated? what conditions?

– Doll, Simon & Daw (2012) “The ubiquity of model-based reinforcement learning”- general survey of how evidence for model-based learning is increasing- brief discussion of how model-free learning could account for many facts, dependingon the partition- “model-based influences appear ubiquitous more or less wherever the brain processes reward information.”

– Lee, Shimojo, O'Doherty (2014, Neuron) “Neural Computations Underlying Arbitration between Model-Based and Model-free Learning”- “prefrontal and anterior striatum implicated in goal-directed control and a region of posterior lateral striatum involved in habitual control”

– 2014: Steve Kennerley conversation- basic setup: Nathaniel Daw's branch task for distinguishing model-free and model-based: (1) you choose up or down, which stochastically delivers you to state red or blue, then (2) get reward contingent just on colour. Now suppose you choose up, and it takes you to the state normally associated with down. Now do you assign the reward to the action or to the state?.- in his work with Nathaniel Daw, they look at monkey neurons, and try to find correlations with model-free and model-based signatures / but they assume that in decisions there is an *averaging* of model-free and model-based.

# CONSCIOUSNESS

* **Crick-Koch hypothesis:** we are only conscious of things that project directly to the PFC. (neural correlates of consciousness)[Q: what kind of evidence that we're not conscious of activity in certain regions?]

# SOCIAL JUDGMENT (“automaticity”)

* **Bem, (1972) “Self-Perception Theory”**
    “Individuals come to ‘know’ their own attitudes, emotions, and other internal states partially by inferring them from observations of their own overt behavior and/or the circumstances in which this behavior occurs”“Self-perception theory (Daryl Bem 1967) makes a stronger statement: individuals do not have the capability to observe directly their own attitudes and, therefore, they need to infer them from their emotions and other internal states. In other words, the individual is like an outside observer who relies on external cues to learn his inner states.”[similar to William James theory of emotion]

* **Nisbett, R. and Ross, S. (1980) “Human inference: strategies and shortcomings of social judgment”**
    Rabin says “Probably the best textbook introducing the heuristics-and-biases program in social judgment.”

* **Gilbert (1989) “Thinking lightly about others: automatic components of the social inference process”**
    Talks about Helmholtz & unconscious inference [very good quotes], as a good model for social judgment: automatic judgment, & then we adjust.Talks about history of social psych as concentrated around the circumstance/personality divide.

* **Devine (1989) “Stereotypes and prejudice: their automatic and controlled components”**
    Highly cited paper. Says that low- and high-prejudiced people have the same knowledge of stereotypes, & will use them to interpret ambiguous data, but low-stereotyped people will suppress the automatic judgments when it's possible.

* **Gilbert (1990) “Unbelieving the unbelievable”**
    “Spinoza suggested that all information is accepted during comprehension and that false information is then unaccepted.” – they find that people are persuaded by information even when they know it's false.

* **Greenwald & Banaji (1995) “Implicit social cognition: Attitudes, self-esteem, and stereotypes.”**
    Propose that much of interest in social psychology is unconscious, and so we should adapt our techniques. “Social behavior is ordinarily treated as being under conscious (if not always thoughtful) control. However, considerable evidence now supports the view that social behavior often operates in an implicit or unconscious fashion. The identifying feature of implicit cognition is that past experience influences judgment in a fashion not introspectively known by the actor.”“Through much of the period since the 1930s, most social psychologists have assumed that attitudes, and to a lesser extent stereotypes, operate in a conscious mode. ” Q: relation with Nisbett & Wilson? “research in social cognition now appears to be taking an important further step along the path that was laid out by Nisbett and Wilson (1977a).”

* **Greenwald McGhee & Schwartz (1998) “Measuring individual differences in implicit cognition: The Implicit Association Test.”**
    First use of implicit association test.

* **Dijksterhuis, A. and Nordgren, L.F. (2006) A theory of unconscious thought. Perspect. Psychol. Sci. 1, 95–109**
    Famous paper. Unconscious Thought Theory (UTT): unconscious thought produces superior decisions.

* **Lieberman (2007, in Fund of Social Neuro) “The X- and C-Systems”**
    Based on distinction between automatic and controlled in neuroscience: he says that existing literature just treats these as two ends of a continuum; but might be productive to think about them as separate systems in the brain. He proposes a division among brain regions.

* **Uleman, et al. (2008, Ann Rev Psych) “Spontaneous Inferences, Implicit Impressions, and Implicit Theories”**
    [seems to be mostly priming studies, & quite vague interpretations]“Over the past 20 years, evidence has grown that much, if not most, social behavior is governed by implicit, even automatic processes: implicit attitudes, inferences, goals and theories, and the affect and behaviors they produce .... Implicit impressions of other people are not open to self-report. They include implicit attitudes toward others, implicit knowledge structures, implicit theories, and implicit behavioral tendencies.”

* **von Hippel & Trivers (2011, BBS) “The evolution and psychology of self-deception”** (Not obviously very useful.) 

* **Bargh et al. (2012, Trends in Cog Science) “Automaticity in social-cognitive processes”**
    They review the concept of automaticity across a bunch of domains (incl. even face recognition).- largely about priming
    “the concept [of automaticity] has now permeated nearly all psychological domains. ”
    * contagion: they say it's now widely established that “the mere perception of the physical behavior of others, as well as the automatic activation of the more abstract category memberships (e.g., racial, gender, role-related) that occurs passively in the course of person perception, results in increased tendencies to behave in the same way oneself (i.e., the ‘perception- behavior link’).” ... “Keizer and colleagues [24] found that people were more likely to behave in unscrupulous ways, such as littering, stealing, or disobeying posted signs, in contexts where there was evidence of past disorder (e.g., grafﬁti, litter).”
    * embodiment, e.g. feeling a hard surface makes problems seem harder.
    * if you evoke sensation of disgust, people judge vignettes to be morally worse.

### criticism of social psych studies
...
1. effect of experience (called “decrement” of illusions, “practice effects” in perception)Note: people may say “the illusion does not disappear with experience”, but we really want to know if people make bets on where the illusion is. It may still appear to them to be distorted (system 1), but we care about their system-2 judgment. / This is what's relevant in economics: how it interacts with considered decisions about money.Also important to know whether there's learning without feedback.

(a) Gibson (1953) “Improvement in perceptual judgments as a function of controlled practice or training.”Survey.

(b) (Schiano & Jordan, 1990; Watson et al., 1991)

(c) Predebon (1998) “Decrement of the Muller-Lyer illusion as a function of inspection time”

(d) van Eee (2000, Perception) “Perceptual learning without feedback and the stability of stereoscopic slant estimation”Judgment improves without feedback

(e) Predebon (2006) “Decrement of the Müller-Lyer and Poggendorff illusions: The effects of inspection and practice”Decrement mainly when you continuously observe the object, not when you observe intermittently. “Taken together, the pattern of results does not support the claim that illusion decrement is primarily a product of practice or repeated trials.”

(f) McCauley and Henrich (2006, Phil Psych) “Susceptibility to the Muller-Lyer Illusion, Theory-Neutral Observation, and the Diachronic Penetrability of the Visual Input System”They say the illusion could be diachronically penetrable, but not synchronically penetrable.

(g) Durgin et al. “Expert performance by athletes in the verbal estimation of spatial extents does not alter their perceptual metric of space”Athletes better than regular people at estimating distances, both verbally and in matching

(h) [ellis1998golf] : golfers know that practice balls are usually lighter. And when you give them a real ball and a practice ball, which is the same size, you find that size-weight illusion works on them.

2. monotonic transformation of cues: its effect on performancee.g. upside down face, invert the eyes only, CV of candidate where everything is expressed as its opposite (male=female), different denominator for numerical values.

(a) Valentine (1988) “Upside-down faces: a review of the effect of inversion upon face recognition”“Several studies have found that face recognition is disproportionately impaired by stimulus inversion when compated to recognition of other classes of visual stimuli. This effect has been interpreted as evidence that face recognition benefits from a ‘special’ process which is not engaged by an inverted face. ... ”[This paper says it's not a special feature of faces; subsequent literature seems to fight back – to say that face-recognition does have a special aspect]

(b) face recognition worse when presented in photographic negative (eg Galper 1970; Kemp et al 1990)

3. incentives

(a) Jenkins et al. (1998) “Are financial incentives related to performance? A meta-analytic review of empirical research.”It's performing tasks, not really perception.

(b) Daniel & Pollman (2010) “Comparing the Neural Basis of Monetary Reward and Cognitive Feedback during Information-Integration Category Learning”Category learning: having monetary incentives makes zero difference (“Subjects fulfilled the criterion of 80% correct answers after an average ± SE of 131.25 ± 20.09 training trials in the rewarded task and after an average of 129.69 ± 17.56 training trials in the unrewarded task. ”)- 

(c) Dienes & Seth (2009, Concsiousness & Cognition) “Gambling on the unconscious” -- artificial grammar learning. When people are indifferent between a random outcome, and their own judgment of grammaticality, still their grammaticallity is better-than-chance. Interpreted as people not being aware of their own judgment.

4. effect of deliberation time

(a) Christopher Chabris 1999 thesis has study of chess games, shows longer deliberation time improves quality of moves.

5. individual differences

(a) Hamburger, Hansen, Gegenfurtner (2007) say they find that susceptibility to illusions is strongly correlated within subjects

6. illusions affecting different modalities

(a) Aglioti DeSouza & Goodale (1995) found that illusions seem to affect vision more than action.

(b) [franz2001action] says that visual illusions affect judgment and grasping by the hand about equally on average. (Other people argue that it's much less for action)

7. robustness of priming

(a) Science News (2012) “The Hot and Cold of Priming”Overview of priming debate

(b) Magnus Johannesson @ SSE says a recent replication effort 80% of papers were replicated

16 PRACTICAL APPLICATIONS

1. Fog

* Ross (1967) “WATER, FOG AND THE SIZE—DISTANCE INVARIANCE HYPOTHESIS”

– Generally finds that size & distance judgments are distorted in the same way

* Ross (1975, New Scientist) ““Mist, murk and visual perception”http://www.psychology.stir.ac.uk/staff/staff-profiles/honorary-staff/?a=27187

– Fog causes upward bias in judgment of distance

– With feedback people learn to adjust estimates

– Fog and distance judgments:http://hfs.sagepub.com/content/48/2/300.abstracthttp://www.allstar.fiu.edu/aero/HumFac03.htm

– - on foggy days people overestimate distances *and* sizes to the same proportion

* Cavallo, Colomb, Dore (2001) “Distance Perception of Vehicle Rear Lights in Fog”

– “the results revealed an average increase of 60% in the perceived distance of vehicles in fog as compared with normal visibility conditions.”
- Fog causes accidents not because of lower visibility, because of misperception of distanceasdf
- They sat people in a car, either in a fog chamber, or on a football field, and asked them to judge distances
- (Figure from Cavallo et al.)


* Cavallo (2002) “Perceptual Distortions When Driving in Fog”Finds no effect on speed judgment, but big effect on distance judgment.

* Bruchner Bell Brandt & Weiss (2006) “Car Backlight Position and Fog Density Bias Observer-Car Distance Estimates and Time-to-Collision Judgments”- They watch a movie of following a car, &then have to estimate distance to the car in front.

* Airbus (2011) “Flight Operations Briefing Notes: Human Performance Visual Illusions Awareness”

– Visual illusions important in 20% of approach-and-landing “events”

– Most are due to observable factors (e.g., weather) so should be able to correct
...
2. Illusions & Flying – general

(a) Watson (2012) “Spatial orientation and disorientation during flight: Illusions during the approach and landing”http://aeromedical.org/Articles/a&l.html

3. Head Mounted Displays

(a) Long US Army report on “HMD: Visual Perceptual Conflicsts & Illusions”http://www.usaarl.army.mil/publications/HMD_Book09/files/Section%2020%20-%20Chapter%2012%20Visual%20Perceptual%20Conflicts%20and%20Illusions%20.pdf

4. Radiology - Mach bands

(a) Daffner (1989) “Visual illusions in the interpretation of the radiographic image.”(a) Mach bands: suppose there's an object which overlaps your image in an x-ray (i.e. whiter), then the perimiter surrounding it tends to look darker - as if really darker. But his examples are not good!(b) background effect:(c) subjective contours: [note: “lucency”~=transparency, they say “looks like a lucency”, i.e. a shadow, a bad thing. ]

(b) Nielsen (2001, J Endodontics) “Effect of Scenario and Experience on Interpretation of Mach Bands”Says that students are more prone to be misled than dentists.(e.g., when two teeth overlap, looks like dark line just outside that region)

(c) Sowden, Davies and Roling (2000) “Perceptual learning of the detection of features in X-ray images: a functional role for improvements in adults' visual sensitivity?”they found that trained radiologists are better at picking out faint little dots in an image. 

# Influences on perception:

**distance / depth**
- size on retina (-) (“Emmert's law”,[anderson2000depth])
- size on retina of neighbouring object (+)
- occlusion of neighbouring object (-) [palmer2007occlusion]
- binocular / motion parallax (“convergence”) (-)
- lens thickness required to focus (“accommodation”) (+?)[if1988accommodation][footnote:
Originally Helmholtz. Putting spectacles on chameleons changes accommodation cue, and so makes them shoot their tongue out too far, or not far enough. Also see Watt, Akeley, Ernst & Banks ().
]
- foreshortening / perspective (-)
- blueness of object (+) [bailey2006real]
- contrast of object (-) (Ross (1975), Mount (1956))
- motion (-) [“kinetic depth effect”]
- brightness (“Pulfrich effect”)
- chromatic abberation (Sundet, 1987)
[nice graph comparing cues in Cutting &vishton[footnote:
Cleaned up version of the graph at http://blog.zabarauskas.com/3d-display-simulation-using-head-tracking-with-microsoft-kinect/
]]

**motion**
 - motion on retina (+)
- motion on retina of neighbours (-)
- colour contrast (~)
- neck muscle stimulation (~) (Craske 1977; Goodwin et al. 1972; [lackner1988some])
**weight**
- pressure (+)
- pressure of preceding object (-) [sherif1958assimilation]
- pressure of preceding objects of same type (-)
- apparent density of material (-) []
- size (-) (non-bayesian) Charpentier (1891); [brayanov2010bayesian]
- temperature difference from body temperature (+)[stevens1979thermal] [footnote:
Originally noticed by Weber. Bayesian explanation: heavier objects press harder on your hands, & so transfer more coldness.
]
**lightness**
- transparency of area \times luminance of neighbour (+)[anderson2011using]
**colour**

- adjacent colour
- apparent transparency [Webster, 2009]
temperature of object   - actual temperature of object (+)[footnote:
we have cold & warm receptors. There are areas of the skin not covered by heat sensors at all. Also receptors for extreme temperatures, which fire when very cold or very hot.
(Encyclopedia of Perception)
]
- temperature of prior object (-)

**touch / pressure**   

- can detect a 1 micrometer bump, and can detect vibrations of even smaller size. 10,000:1 difference between just-detectable and painful level, but for absolute discrimination, only four levels are practical. Far higher sensitivity on fingertips than on chest. Braille reading can only go at 60 wpm compared to 300 wpm for visual reading  
– seems this due to temporal interference of touch perception. Adaptation: if you slowly introduce a stimulus, it won't be observed. Perception much improved if you mix space and time (e.g., stroke a surface instead of just touch it). Cholewiak & Cholewiak in Encylopedia of Perception (2010), “a usable dynamic range between just noticing a stimulus and a comfortably "loud" level can be as much as 10,000:1. Despite this large range, if we wanted to use tactile signals-say, in a cardiac emergency code indicating a range of importance from "Check your blood pressure" to "Call 911!"-cognitive limitations restrict the number of useful intensity levels to three or four, even though we can dis­criminate many more differences when directly compared.”

**location of stimulus**

- path of preceding/following stimuli (Cutanous rabbit)
- location of stimuli in other senses (ventriloquist illusion)

**proprioception**  - muscle vibration (Mergner, 1991) (Pinnochio illusion)

**syllable**
- sound (~)
- context (~)
- movement of lips (+) (McGurk effect)
...
4. Wolfe et al., “Sensation & Perception” (—-) (I have a copy in the US)

5. Handbook of Sensory Physiology (1974) (Nick Cutfield recommended it)
