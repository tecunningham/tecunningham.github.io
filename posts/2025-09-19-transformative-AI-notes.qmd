...
:     1. **There is no standard definition or metric of machine intelligence.** The lack of a definition makes working in this field difficult.
...
The NBER workshop.
: The NBER workshop was a set of papers on .
...
: I think it's reasonable to have high uncertainty: (1) it's possible that AI will get very good soon; (2) it's difficult to anticipate what will happen if it does.
...
: This will be a somewhat vague statement: I'm convinced that the most satisfying explanations of AI's impact across different domains of human life (entertainment, news, hiring, shopping, etc.) will refer to the statistical properties of those domains, e.g. the degree of correlation, the latent dimensionality.
      ...
      Put more strongly: the relative effect of a human vs computer brain on a domain will depend on the closeness of the fit between the structure of the brain and the structure of the domain.
