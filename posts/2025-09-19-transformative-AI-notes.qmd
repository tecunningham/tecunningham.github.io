...
::: {.column-margin}
   Thanks to comments from Daniel Björkegren & Andreas Haupt.
:::
...
:     1. **There is no standard definition or metric of machine intelligence.** The lack of a definition makes working in this field difficult. However this is a
      1. **There is no standard model of AI's economic impact.** Each author uses their own set of assumptions, and most are quite *ad hoc*.
      2. **I expect wages to fall eventually.** Many economists have argued that AI will cause wages to rise, even if AI can do everything. However I think they fail to take resource costs seriously: the land and energy required for a human to do some work will be far greater than the requirement for a computer to do the same.
      3. **I expect AI will have a huge impact on science and technology.** However I'm skeptical of the existing models of AI R&D, which fit curves to human R&D and try to extrapolate from that.

##          The Workshops

The Windfall Trust workshop.

: This workshop asked participants to discuss four possible future scenarios. Each scenario had a page-long description of what might happen, but I think they were basically organized along these lines:
...
: There's a standard set of ideas which have been circulating in AI circles for the past decade. This is an important context for the discussion at both workshops.
    ...
    Academic economists have tended to bristle at each of these points:
...
: Both workshops were intended explicitly for discussion of a hypothetical: what would happen *if* AI capabilities keep increasing?
      ...
      Why? People gave a few different reasons: (1) they were doubtful that AI would improve very quickly; (2) they thought it's more important to work on the economics of actually existing AI; (3) they thought the economics of superhuman AI was formally less interesting; (4) they thought it was important, but were nervous about being perceived as overly credulous by their colleagues.

The field still seems a little inchoate.

: It seems to me that the field of economics-of-AI is still pretty open:

      1. There is no standard way of modelling AI in economics (more on this below).
...
: Over summer 2024 many economists predicted that AI would have small economic impacts:
      ...
      - Daron Acemoglu predicted AI would cause 0.06% incremental productivity growth over the next 10 years.
...
: Two quantitative forecasts of AI's GDP impact are @acemoglu2024simple (0.06%/year) and @aghion2024ai (1%/year). Both of those papers model AI's future economic impact as primarily a *diffusion* process: they treat the arrival of AI as a one-time shock like electricity or the steam engine which is gradually adopted.
      ...
      I think this a bad assumption, AI's capabilities are getting dramatically better over time.

      We could decompose the growth in LLM adoption over a given period into (i) quality growth; (ii) diffusion. It's very difficult to separate these, but I think it's a reasonable guess that growth over the last 12 months (Sept 2024 to Sept 2025) is about 1/2 diffusion of existing capabilities, and 1/2 the causal effect of new capabilities (precisely: growth would've been half as large if models had been frozen in Sept 2024). If this is true then a forecast which was just based on the diffusion of existing capabilities would have dramatically under-estimated the impact of AI, and the gap would become larger as the horizon got longer.

      Of course it is more difficult to forecast a process with both diffusion and quality growth, but I think we need to try.
...
: This is a more philosophical point. Economists take it as given that it's good for people to get what they want, but we don't talk much about where those wants come from. This silence feels particularly notable when talking about radical AI.
      ...
      We don't often talk about where those preferences come from. But we do know where they come from: mostly from evolution (we are hard-wired to prefer things that were correlated with survival), and the rest from socialization (we learn to prefer things that we saw our parents prefer).[^labile]

      What does this mean for transformative AI: (1) that the preference-maximizing utopia might not look intuitively like a utopia, e.g. maybe it would be people self-stimulating their pleasure receptors; (2) that people brought up in different ways would choose different utopias, and there's no principled way to choose between them.[^utopia] Different societies have already chosen to use their additional surplus in very different ways: to have more children; to devote more time to praising and glorifying god; to have more time at leisure; to consume more goods and services; to live heroically. Once you've been raised with a certain set of values they are somewhat fixed.
...
: Each of the papers in the NBER workshop used some assumption about how AI changes the production function, but there were many different assumptions. There is no standard way of modelling AI in economics.
      ...
      Some of the ways that AI is modelled in economics:

      - Capital can do a wider set of tasks.
      - Humans can do certain tasks more quickly.
      - Humans can do a wider range of tasks (e.g. AI spreads expertise).

      In many papers there's no specific assumption on the types of task, just a parameter that reflects the share of tasks affected. In some papers there are more structural assumptions on how tasks are affected, but there are a wide variety of assumptions, e.g. AI gives better predictions, or AI shares information. In some papers there are empirical assumptions, e.g. taking "AI exposure" indices across tasks.

      The difficulty of economists n it's a famously difficult problem to give a general terminology or metric for machine intelligence. For 80 years computer scientists and psychologists have been struggling with it.

      I think having a better characterization of machine intelligence is .
...
: In 2023 and 2024 AI ability was often described in terms of its grades on standardized tests (SAT, GRE, LSAT), by the equivalent years-of-education (Aschenbrenner and OpenAI talked about "PhD-level intelligence"). In 2025 METR (@kwa2025longtasks) made a good argument that the most parsimonious model of intelligence is the human-time-length of tasks.
...
: This will be a somewhat vague statement: I'm convinced that the most satisfying explanations of AI's impact across different domains of human life (entertainment, news, hiring, shopping, etc.) will refer to the statistical properties of those domains, e.g. the degree of correlation, the latent dimensionality.

      Put more strongly: the relative effect of a human vs computer brain on a domain will depend on the closeness of the fit between the structure of each type of brain, and the structure of the domain.

<!-- reduced form: the returns to compute, or returns to experience, but there's a structural model -->

Some examples.

:   1. **The concentration of the market for AI depends on the dimensionality of the world.** If the world is intrinsically high-dimensional then the returns to model scale will be steadily increasing, and so we should expect high market concentration. If instead the world is intrinsically low-dimensional then the returns to scale will flatten: many people could train equally good models, and there should be high competition and low markups.
