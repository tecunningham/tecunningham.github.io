...
: Last week I went to two workshops: the Windfall Trust's ["Economic Scenarios for Transformative AI"](https://futureoflife.org/project/the-windfall-trust/) and the NBER's ["Workshop on the Economics of Transformative AI.](https://www.nber.org/conferences/economics-transformative-ai-workshop-fall-2025)
...
My take: we are driving in fog.

: My view is that there are wide error-bars: it's possible that AI will plateau, it's possible that it will very soon become autonomous and smarter than humans. It seems sensible to be prepared for both outcomes.

Many people avoided talking about transformative AI.
...
: Both workshops were intended explicitly for discussion of a hypothetical: what would happen *if* AI capabilities keep increasing?
      ...
      However most of the economists resisted the hypothetical. If you look at the NBER papers about half are effectively discussing the effects of AI with 2024-level capabilities, not transformative AI.
      
      Why? People gave a few different reasons: (1) they were doubtful that AI would improve very quickly, so it didn't seem a useful discussion; (2) they thought the economics of existing AI is more important to work on; (3) they thought the economics of superhuman AI was formally less interesting; (4) they were nervous about being perceived as overly credulous.

The field is inchoate.

: It seems to me that the field of economics-of-AI is still pretty open:

      1. There is no commonly accepted definition of Artificial General Intelligence, or Superintelligence, or Transformative AI. Different papers use quite different definitions.
      
      2. There are relatively few canonical models in the economics of AI. The closest are perhaps: (1) the @acemoglu2018race model of automation as capital being able to perform tasks autonomously; (2) the @aghion2019artificial model of automation's effect on economic growth.

      @brynjolfsson2025agenda is a "research agenda for the economics of transformative AI": it's striking that it lists many interesting questions, but cites relatively few papers, and the papers it does cite are generally treated as only interesting conjectures.
      
I don't think people appreciate the speed of improvement.

: People gave various examples of things the models still couldn't do: (1) ARC-AGI; (2) understand world models; (3) reliably operate a vending machine. These are all good examples but I don't think there was a good sense of the rate of progress. It seems very likely that the primary examples of tasks that AI cannot do in 2025 will turn into tasks that AI can do in 2026 (the same was true in 2024 and 2023).
...
: Over summer 2024 many economists predicted that AI would have very small economic impacts:
      ...
      I have heard much less of this kind of talk in 2025, there are few people who expect AI to have negligible economic impact.
...
: The two most-cited forecasts of AI's impact on GDP are @acemoglu2024simple (0.06%/year) and @aghion2024ai (1%/year). Both of those papers model AI's future economic impact as primarily a *diffusion* process: they treat the arrival of AI as a one-time shock like electricity or the steam engine which is gradually adopted.

: I think this a bad assumption, it ignores the primary engine of growth.

: We could decompose the growth in economic impact over a given period into (i) quality growth; (ii) diffusion. It's very difficult to separate these, but I think it's a reasonable guess that growth over the last 12 months (Sept 2024 to Sept 2025) is about 1/2 diffusion of existing capabilities, and 1/2 the causal effect of new capabilities (precisely: that growth would've been half as large if capabilities had been frozen in Sept 2024). If this is true then a forecast which was just based on the diffusion of existing capabilities would have dramatically under-estimated the impact of AI, and the gap would be larger as the horizon got longer.

: It may be that Acemoglu, Aghion and Bunel expect that AI capabilities will plateau but this a critical qualification.

: How would you write a quantitative forecast which included growth in AI capabilities? It's more difficult than forecasting diffusion, we need to assign some speed of growth to AI capabilities, and that growth rate is hard to measure (noting that we have no standard way of measuring AI capabilities).
...
LLMs are mostly chatbots.

: Around 1/3 of adults in rich countries are regularly using chatbots (ChatGPT, Gemini, Claude).

      This was not obvious a few years ago: many people expected LLMs would have widespread adoption in process automation -- e.g. automatically responding to customer service inquiries, or doing agentic tasks. A natural interpretation is that LLMs are not yet reliable enough to operate without human oversight, but they are enormously helpful as advisors.
...
: Each of the papers in the NBER workshop used an assumption about AI's effect, but each assumption differed. There is no canonical model of computer intelligence.

        In fact this is a famously difficult problem: for 80 years we've been struggling to come up with a good metric of computer intelligence.
...
: This will be a somewhat vague statement: I'm convinced that the most satisfying explanations of AI's impact across different domains (entertainment, news, hiring, shopping) will refer to the statistical properties of those domains, e.g. the degree of correlation, the latent dimensionality. Put more strongly: the relative effect of a human vs computer brain on a problem will depend on the closeness of the fit between those brains and the structure of the data. 
...
:   1. **The concentration of the market for AI depends on the dimensionality of the world.** If the world is intrinsically high-dimensional then the returns to model scale will be steadily increasing, and so we should expect high concentration.
    2. **The effect of AI on scientific progress depends on the structure of the world.** If the world has a simple latent structure then progress will be more bottlenecked by intelligence than by data, and so we should expect advances in AI to dramatically accelerate scientific progress (argued below).
