...
published-title: ""
date: April 28 2024 (first version January 23 2023)
execute:
  echo: false
  warning: false
  error: false
...
**Economics literature on social norms mostly treats preferences as fixed.** There is a lot of economic literature on "social norms", and is applied to behaviors like generosity, bargaining, fertility, & medical treatment.^[Young (2005) is a good review.] However I believe the majority of this literature treats preferences as fixed so that norms are modelled as multiple equilibria (Schelling (1978), Axelrod (1986), Mackie (1996)), or with a raw preference to conform (e.g. Young, 2005), or a raw preference to sanction those who deviate from a norm. I model norms as essentially *imitation*.
...
**Relation with the Becker-Murphy (1988) model of addiction.** Becker and Murphy claim that consumption of addictive goods (tobacco, heroin) is consistent with rational choice given that there is an inter-temporal complementarity: consuming at time $t$ increases the value of consuming at $t+1$. They say there's evidence that people are clear-sighted about the complementarity: when people anticipate a cigarette tax in the future then they smoke less now.
   ...
   In addition it seems likely that a person's *earliest* choices are partly naive about long-term effects: when a child or adolescent eats, smokes, or drinks alcohol, they are unlikely to fully anticipate the long-run consequences on their health or on their future tastes. If this is true this would be an additional reason (independent of peer effects) to tax or restrict youthful consumption.^[Becker (1992) is a long essay about habits and addiction that acknowledges the existence of acquired preferences though doesn't seem to pursue the implications. Becker says *"[a]ltruistic parents ... may refrain from smoking even when that gives them much pleasure because their smoking raises the likelihood that the children will smoke."*.]
...
2. **A fixed-cost model.** I believe that this peer-effects model is isomorphic to a model with spillovers due to production with fixed costs, i.e. a Hotelling monopolist who must choose a point on a line, as in Anderson and Waldfogel (2005). However I would like to confirm this.

3. **Matrix of effects.** I think you can characterize the theory with two derivatives: the externality and the strategic complementarity. I think it would be useful to give examples of the 9 permutations (pos/zero/negative; pos/zero/negative).
