...
<!-- OLD URL: http://tecunningham.github.io/2023-01-23-peer-effects-sin-taxes.html
   ...
   TODO: the diagrams below w externalities -->
...
**Discussion of optimal taxation rarely discusses peer effects.** DeCicca (2022) mention the existence of an empirical literature on the peer effects on smoking, but don't discuss the findings, or whether it would have implications for setting taxes. 
...
The basic difference between Becker-Murphy and my model is that their model is about within-person complementarities and mine is about between-person complementarities. The between-person complementarities generate an externality, and therefore (unlike in Becker-Murphy) a reason to introduce a tax.
