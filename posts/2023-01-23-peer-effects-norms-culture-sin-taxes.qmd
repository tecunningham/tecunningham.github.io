...
<!-- 
A note I wrote about peer effects in behavior, and the implications for how we think about policy:

   1. The majority of variation in preferences is due to the influence of peers: tastes for food, alcohol, tobacco, music, art, and leisure, vary much more between societies than within societies.
   2. Peer influences imply that group behaviour will respond to changes in the environment with a lag. Today's consumption will reflect yesterday's prices.
   3. The slow adjustment of prefernces imply welfare can be improved. We ought to tax goods that have been recently been discovered to be unhealthy: tobacco, sugar, trans fats & saturated fats.

 -->

<!-- <span style="background:yellow;">==Draft, don't circulate further please.==</span> -->

**In short:**^[First version January 23 2023. Thanks to comments and conversations with many, incl. Jon de Quidt, David Atkin, Donald Kenkel, Dmitry Taubinsky, Charlotte Paul, & Ruth Cunningham.]
