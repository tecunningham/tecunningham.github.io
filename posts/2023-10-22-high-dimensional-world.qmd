...
(XY Han says that Jon Kleinberg has related work in 2015-2020 -- he finds that different architectures trained on the same task will lead to similar latent representations ("canonical correlation analysis"))

#                 Perceptual Manifolds

Chung, Lee, Sompolinsky (2018) "Classification and Geometry of General Perceptual Manifolds"


# 2026-01-08 |                      

Andrew Gordon Wilson (2026) "From Entropy to Epiplexity: Rethinking Information for Computationally Bounded Intelligence"

> "Shannon information and Kolmogorov complexity ... assume observers with unlimited computational capacity and fail to target the useful information content. "

> "we introduce epiplexity, a formalization of information capturing what computationally bounded observers can learn from data. Epiplexity captures the structural content in data while excluding
time-bounded entropy, the random unpredictable content exemplified by pseudorandom number
generators and chaotic dynamical systems. 