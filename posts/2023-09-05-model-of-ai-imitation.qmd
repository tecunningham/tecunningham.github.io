...
**If we train an AI to *imitate* humans, will it ever *beat* humans?** Large language models (LLMs) are trained to predict what humans would say in a given situation (with some qualifications, see below). It would seem to follow that they would never be *better* at answering questions than a human.[^objective]
   
   [^objective]: Many other ML models use human-generated labels as the ground truth: image recognition, language understanding, text classification, medical diagnosis.
...
**Performance over time.** 
   ...
   [Language and image recognition abilities.](https://ourworldindata.org/brief-history-of-ai)

   However the paper that collected this data ([Kiela et al.](https://arxiv.org/pdf/2104.14337.pdf)) argues that performance on benchmarks significantly exaggerates true performance: *"Models that achieve super-human performance on benchmark tasks (according to the narrow criteria used to define human performance) nonetheless fail on simple challenge examples and falter in real-world scenarios."*

![](images/2023-09-18-08-13-45.png)

[Performance on coding, math & knowledge tests.](https://ourworldindata.org/grapher/ai-performance-coding-math-knowledge-tests)

   ![coding, math & knowledge](images/2023-09-18-08-06-51.png)

[Chess ability](https://ourworldindata.org/grapher/computer-chess-ability)

   ![chess ability](images/2023-09-18-08-10-14.png)

**Miscellaneous.**

- **Papers on persuasion.** A number of papers compare the persuasive power of LLM-generated text to human-generated text (@bai2023persuade, @goldstein2023persuasive, @hackenburg2023persuasive, @matz2023personalized, @palmer2023large, @qin2023large). They all find that LLM does relatively well, but none show clear signs of computer superiority.

- @koivisto2023creativity: they compared GPT4 to online recruited humans (£2 for 13 minute task) in giving "creative" uses for everyday items. The prompt was to "come up with original and creative uses for an object", objects were "rope", "box", "pencil" and "candle." The responses were rated by humans for their "creativity/originality." GPT-4 responses were perhaps 1SD above the average human score, but the difference was smaller for the best response for each user.
