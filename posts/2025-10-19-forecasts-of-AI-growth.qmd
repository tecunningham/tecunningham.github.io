...
overall = "❌ Fail" if hard_fail else "⚠️ Warning" if any_warn else "✅ Pass"
...
lines = [
    ...
    f"- {status['quotes_verified']} Bib quotes verified against sources (LLM-assisted)",
    f"- {status['growth_consistency']} Growth values consistent with quoted text (LLM-assisted)",
    f"- {status['abstracts']} Abstracts present for all cited sources (warning if missing)",
    f"- {status['coverage']} Coverage check against recent sources (manual + web search)",
    "",
    f"Last checked: {dt.date.today().isoformat()}",
    "</details>",
]
...
| ---------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------- | ----- |
| March 2023       | @krugman2023ai (Paul Krugman) | small                 |     *"history suggests that large economic effects from A.I. will take longer to materialize than many people currently seem to expect ... ChatGPT and whatever follows are probably an economic story for the 2030s, not for the next few years."*  |
| July 2024        | @gans2024tweet (Josh Gans)                                                 | small                    | *"I don’t think it will boost growth appreciably ... over the next 10 years"*      |
| Oct 2025         | @karpathy2025dwarkesh (Andrej Karpathy)                                                                                      |     no change in trend     | Dwarkesh: *"Just to clarify, you're saying that the rate of growth will not change."* ... Karpathy: *"Yes, my expectation is that it stays in the same pattern."* <br /><br />This doesn't pin down the *incremental* effect of AI on growth, but it's presumably between 0% and 2%.                                                                                                                                                                                                                          |
