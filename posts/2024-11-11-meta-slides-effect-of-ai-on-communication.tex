...
\pandocbounded{\includegraphics[keepaspectratio]{images/2024-11-11-14-45-57.png}}
...
\includegraphics[width=5cm,height=\textheight,keepaspectratio]{images/2024-11-11-14-54-12.png}
\end{description}
...
\includegraphics[width=5cm,height=\textheight,keepaspectratio]{images/2024-11-11-14-57-56.png}
\item[OpenAI work]
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/2023-09-19-09-55-57.png}
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/2024-11-12-09-39-14.png}
\end{frame}
...
(2023)).\footnote<.->[frame]{Arnaud Norman
...
attributed to improvements in the quality of
classifiers.\footnote<.->[frame]{It is important to remember that the
  ``proactive rate'' is the share of \emph{detected} content that is
  detected by AI, the share of \emph{violating} content that is detected
  by AI will certainly be significantly lower but is not generally
  reported. See Meta's
...
majority of problematic content.''\footnote<.->[frame]{Zuckerberg,
  \href{https://www.facebook.com/notes/751449002072082/}{``A Blueprint
  for Content Governance and Enforcement''}}
\end{description}

\pandocbounded{\includegraphics[keepaspectratio]{./2023-01-31-social-media-suspensions-data_files/figure-html/unnamed-chunk-28-1.png}}
\end{frame}
...
zero.\footnote<.->[frame]{Strictly speaking: this will be true if no
  content has a probability of being labelled as positive by a human of
  exactly zero.}
\end{description}
\end{frame}
...
violations.\footnote<.->[frame]{A related phenomena is people using
  selective truths to give an impression that is false.}]
\hfill
\begin{itemize}
\tightlist
\item
...
community.\footnote<.->[frame]{Platforms already have some policies that
...
remain.\footnote<.->[frame]{In Facebook's Marketplace it is prohibited
  to list guns for sale. As a consequence people began to list gun
  \emph{cases}, with the understanding that a case was standing in for a
  gun. Facebook then updated their policy to prohibit selling gun cases.
  In turn people began to list gun stickers as stand-ins for guns. See
  WSJ reports from
...
paper.\footnote<.->[frame]{https://www.axios.com/2022/11/28/china-protests-blank-paper-covid}
\end{description}
\end{frame}
...
media,\footnote<.->[frame]{The goals of platforms in content moderation
  are discussed in my note on ranking, Cunningham (2023).} and can
control the prevalence even without reliable classifiers. E.g. Meta and
YouTube dramatically decreased the prevalence of misinformation over
2016-2020 not primarily through real-time detection of whether a given
claim is false, but by (1) adjusting ranking to penalize publishers who
tend to circulate false claims; (2) punishing publishers who circulate
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.0408}}
