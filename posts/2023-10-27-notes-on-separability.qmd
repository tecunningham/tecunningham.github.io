...
\begin{tikzpicture}[color=red, line width=1]
   ...
   \draw (2,1) -- (1,2) node[midway,fill=white,sloped] {$\preceq$};
...
#| column: margin
#| fig-width: 2
#| fig-cap: independence
\begin{tikzpicture}[color=red, line width=1]
   \draw[<->,black] (0,5)--(0,0)--(5,0);
   \draw (2,4) -- (2,1) node[midway,fill=white,sloped] {$\succeq$};
   \draw[dotted] (4,4) -- (4,1) node[midway,fill=white,sloped] {$\succeq$};
\end{tikzpicture}
```
