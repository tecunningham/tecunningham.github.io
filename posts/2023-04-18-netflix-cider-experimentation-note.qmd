---
title: Experimentation - Notes from CIDER
...
<!-- 
- tecunningham.github.io/posts/2023-04-18-netflix-cider-experimentation-note.html
- **Leontief sandwich.**
...
**Experiment-related problems can be broken into four types:**
...
1. **The inference problem.** What's our best estimate of the true effect given the observed effect? This comes up especially when we have a set of different observed effects, e.g. across experiments, across subgroups, or across time.
   ...
   Often people deal with these problems by adjusting confidence intervals (e.g. Bonferroni, always-valid). However I think a better approach is to let users make their own judgments but help them with *benchmark* statistics so they can compare this experiment's result to a reference group.

2. **The extrapolation problem.** Given an effect on metric 1 what's our best estimate of the effect on metric 2? This describes the problem of observational inference, proximal goals, and extrapolation.
