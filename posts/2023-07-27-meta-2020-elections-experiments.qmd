...
3. The paper finds no significant effect on their two "affective polarization" measures (-0.08 $\pm$ 0.08 SD, and 0 $\pm$ 0.04 SD), however the 2020 papers which cite @allcott2020welfare seem to treat it as finding that Facebook has a positive effect on "polarization" without noting that it has a null effect on *affective* polarization.
