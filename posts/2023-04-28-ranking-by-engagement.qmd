...
<!-- 
 - On github.io: http://tecunningham.github.io/2023-04-28-ranking-by-engagement.html 
...
Tom Cunningham, May 8 2023.[^note]

[^note]: tom.cunningham@gmail, [@testingham](https://twitter.com/testingham). I worked at FB for 5 years, and Twitter for 1 year, now affiliated with the [Integrity Institute](https://integrityinstitute.org). This note entirely based on public information. Thanks to comments from Jeff Allen, Jacquelyn Zehner, David Evan Harris, Jonathan Stray, and others.
...
As a twitter thread:
- Not big tight paragraphs, have some space between each point, don't go up to the full 240
- Put images where possible, perhaps covariance in very first tweet.
