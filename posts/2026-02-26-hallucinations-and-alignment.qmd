...
- Claims:
    ...
    - Simplex representation:
        ...
        - We can illustrate different empirical results: SimpleQA, AbstentionBench, Abstain-QA. Put the simplex in the body, numerical results in the appendix.
    

- Additional notes
    - Emphasize that I mostly follow Kalai et al. treatment, but add some helpful visualizations. 
...
- Structure:
    ...
    - Related literature: start with a chronological list; keep focus on Chow (1970), Herbei and Wegkamp (2006) (+ brief mention of followups), Kalai et al. (2025), and Kadavath et al. (2022).
...
\begin{tikzpicture}[>=stealth, scale=2.2]
  ...
  \begin{scope}[xshift=0cm]
    \MMBaseSimplex{Reward accuracy}
    \node[font=\scriptsize] at (0.50,0.86) {$U = p_s$};
    \begin{scope}
  ...
  \begin{scope}[xshift=1.45cm]
    ...
    \def\piFail{-1.0}
    \def\piAbst{0.0}
    \MMBaseSimplex{Punish failure}
    \node[font=\scriptsize] at (0.50,0.86) {$U = p_s - \lambda p_f,\ \lambda=1$};
    \MMIndifferenceGrid
  \end{scope}
  ...
  \begin{scope}[xshift=2.9cm]
    \MMBaseSimplex{F1}
    \node[font=\scriptsize] at (0.50,0.86) {$U = \frac{2p_s}{1+p_s+p_f}$};
    \begin{scope}
      \clip (0,0) -- (1,0) -- (0,1) -- cycle;
...
\begin{tikzpicture}[>=stealth, scale=1.0]
  ...
  \node[below] at (\xVerify,-0.25) {$p^*_{\mathrm{verify}}$};
...
\begin{tikzpicture}[>=stealth, scale=2.2]
  ...
  \input{_tikz/marschak_machina_shared.tex}
	  ...
	  \begin{scope}[xshift=0cm]
		    ...
		    \node[font=\tiny, anchor=west] at (0.392,0.608) {GPT-4o};
		    \node[font=\tiny, anchor=west] at (0.437,0.481) {o1-preview};
		    \node[font=\tiny, anchor=west] at (0.092,0.905) {GPT-4o-mini};
		  \end{scope}

	  \begin{scope}[xshift=1.45cm]
		    \MMBaseSimplex{AbstentionBench}
		    \MMIndifferenceGrid
		    \foreach \x/\y in {
		      0.437/0.103,
		      0.272/0.068,
		    ...
		    \node[font=\tiny, anchor=west] at (0.443,0.103) {DeepSeek R1 distill};
		    \node[font=\tiny, anchor=west] at (0.278,0.068) {o1};
		    \node[font=\tiny, anchor=west] at (0.241,0.325) {L3.1 8B base};
		  \end{scope}
	  ...
	  \begin{scope}[xshift=2.9cm]
		    ...
		    \node[font=\tiny, anchor=west] at (0.726,0.191) {GPT-4 32K};
		    \node[font=\tiny, anchor=west] at (0.617,0.374) {GPT-3.5};
		  \end{scope}
\end{tikzpicture}
```
