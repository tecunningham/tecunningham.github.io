...
Claim: labs will switch from selling shovels to using the shovels.
...
:     1. _Probably can ignore inference costs._ -- seems like main implications are just from value side, & ignoring cost.
      1. _Distinction between local vs global value._ -- (not quite rivalness or excludability, but correlation in value).
      2. _Distinction between large and small problem._
...
# 2025-12-29 |                      references from Elsa Jiang
