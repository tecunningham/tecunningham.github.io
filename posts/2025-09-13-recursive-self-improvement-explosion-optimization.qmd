...
: 
    ...
    We can make a very rough guess at our current state, as of April 2026:[^ryan]

    1. Augmentation: agents are accelerating researcher productivity by 50%.
    2. Partial Automation: agents are able to make autonomous contributions equivalent to around 1 month of a researcher's work.
...
: 
    ...
    1. The limited supply of inference compute for automated running researchers;
    2. The limited supply of compute for running research experiments;
    3. Logical limits on research progress, e.g. statistical ceilings on algorithmic efficiency.
