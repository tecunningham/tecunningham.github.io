...
: 
    ...
    1. _Augmenting AI researchers:_ AI researchers self-report big efficiency gains, e.g. @anthropic2025claude_work self-report approximately 50% productivity gains, and @anthropic2026risk estimate 100% productivity gains.^["Productivity uplift estimates ranged from 30% to 700%, with a mean of 152% and median of 100%."]
...
##              @jones2026pastautomation

Model
: 
$$
    \begin{aligned}
    \text{CES task model} \quad & \text{Same as before } \Rightarrow Y_t \text{ and } \Omega_{kt} \\
    \text{Idea PF} \quad & \dot Q_t = \bar q R_t^{\lambda} Q_t^{\phi} \\
...
: 
    ...
    - Assume a functional form on comparative advantage, with $\bar{f}$ maximum.
