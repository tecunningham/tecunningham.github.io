...
::: {.column}
   ...
   - Frontier training compute is increasing around 4-5X/year (black points shifting right), though spend/cost growth is slower
   ...
   3. Labs are probably spending relatively more on R&D than on any single frontier training run. E.g. Epoch estimates that OpenAI spent much more on experiments and broader R&D compute than on the final training runs of released models.
