...
:  1. Full automation / perfect substitute. Once you hit a threshold of intelligence. E.g. replacing tollbooth operator with automatic tollbooth.
   2. Partial automation -> can do some subset of tasks, efficiency gain depends on elasticity of substitution.
   3. Speedup -> increases efficiency on all tasks.
...
: There's some distribution of values, then you get a very nice expression. The expected value of $N$ draws just depends on the distribution of values $v$, & the extreme-value distribution. This is exactly Kortum (1997).
