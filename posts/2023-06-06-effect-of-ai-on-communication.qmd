...
There has been some anxiety that computers will be used to create messages that are much more persuasive than would be created by a human, e.g. .

It is difficult to make generalizations about overall human persuadability:

1. Each decade of the 20th century has had some prophets warning of the new technologies of human manipulation: using subcoscious associations (Bernays), using conditioning (Skinner), using subliminal messages (Packard), using brainwashing (Sargant), using propaganda techniques of Fascism (), using the power of conformity (Asch, Zimbardo), using priming and nudges (Bargh, Thaler), or using psychological profiling (Cambridge Analytica).

2. Carefully measured evidence of persuasive effects tend to be low. 

3. Nevertheless 1/3 of the economy is devoted to persuasion, and attitudes and preferences vary between populations primarily due to social context implying there must be *some* extra-rational means by which people form their attitudes.

As a bsaeline I think it's fair to say that over the last 100 years public discourse has consistently over-rated the suggestibility of humans. Freudian 
