...
predictions.\footnote{The only review article I'm aware of is Lu and
  Zhou (2021) from 2021.}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-1-1.pdf}
...
\includegraphics{images/2024-09-06-10-46-02.png} In Western countries
GDP/capita has increased by about 20 times over 1820-2022
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-2-1.pdf}
...
\includegraphics{images/2024-08-19-14-36-53.png} Hours worked per worker
fell by about 50\% since 1870. In addition people now start work at
later ages and spend more years in retirement
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-3-1.pdf}
...
the increase in output.\footnote{Boppart and Krusell (2020) say ``across
...
0.7.\footnote{If the relative price of output fell by 10X and the
...
\includegraphics{images/2024-08-20-12-43-29.png} US employment shares
over time
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
goods, and so now spend most of their income on services.\footnote{Nordhaus
...
\item
  J. Bessen et al. (2023) finds that automation decreases the employment
  of incumbent workers in Holland, but they find no effect of computer
  adoption.
\item
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-5-1.pdf}
...
\includegraphics{images/2024-08-20-11-54-54.png} from ILO (2015).

\end{footnotesize}}

\marginnote{\begin{footnotesize}

\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
since 1980.\footnote{Autor et al. (2020) say \emph{``Although there is
...
labor share of income remains constant.\footnote{Gechert et al. (2022)
...
technological changes which have strengthened competition.\footnote{They
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-7-1.pdf}
...
increase with automation.\footnote{This discussion is taken from Aghion,
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-8-1.pdf}
...
advantage, and thus gains from trade. This argument is made by Smith
(2024): ``humans will have plentiful, high-paying jobs in the age of AI
dominance.''
...
of output will fall.\footnote{This is what happens in Acemoglu and
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-9-1.pdf}
...
dramatically.\footnote{Smith (2024) seems to acknowledge that this
  argument undercuts the comparative advantage argument for high wages.
  He has two responses: (1) that the government would limit energy use
  by AI (``if human lives are at stake \ldots{} most governments seem
  likely to limit AI's ability to hog energy.'') or (2) that the
  non-energy costs of AI compute are high (``turning energy into compute
  is really, really expensive and hard \ldots{} {[}t{]}hose bottlenecks
  are specific to compute; unlike energy, they're not things that you
  can allocate back and forth between compute manufacturing and human
  consumption.'')}
...
activity.''\footnote{\href{https://www.nytimes.com/2024/03/22/opinion/ai-jobs-comparative-advantage.html}{Peter
  Coy, NY Times March 22 2024}.}
\end{description}

\marginnote{\begin{footnotesize}

\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-10-1.pdf}
...
practice.\footnote{It's closely related to an informal argument in Autor
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
goods that can be produced by capital.\footnote{This discussion is taken
  from Aghion, Jones, and Jones (2019) on p4.}
\end{description}

\marginnote{\begin{footnotesize}

\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-12-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-13-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-14-1.pdf}
...
\(N\)).\footnote{A nice observation (p1500): if the CES coefficients
...
\begin{description}
\item[Caselli and Manning (2019), ``Robot Arithmetic: New Technology and
Wages'']
They say that new technology can decrease wages in the short run, but
when capital reaches equilibrium then average wages should increase.

The conditions: ``we assume that labor is the only fixed factor, that
the interest rate is unaffected by new technology, that there are
constant returns to scale and perfect competition, and that we are
comparing economies with different levels of technology in steady
state.''
...
\item
  Raise the average wage, if the price of investment goods does not
  increase relative to the price of consumption goods (\& they argue
  this is typically true).
\item
  Raise all wages if labor is perfectly mobile (labor types are
  perfectly elastic).
\end{enumerate}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-15-1.pdf}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.4122}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0382}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0840}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.4656}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-16-1.pdf}
...
wages of unskilled workers.\footnote{I believe A. Agrawal, Gans, and
  Goldfarb (2023) has the same basic argument but I could not find a
  copy online.}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-17-1.pdf}
...
\includegraphics{images/2024-08-20-12-30-22.png} They predict that the
real compensation of labor will increase then decrease as AI advances.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5304}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0435}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4261}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-18-1.pdf}

\end{footnotesize}}

\marginnote{\begin{footnotesize}

\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-19-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-20-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-21-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-22-1.pdf}
...
\item
  ...
  tradeoff becomes much more favorable, if we are utilitarians, because
  there are years of life on both sides of the ledger.
\end{enumerate}
\end{description}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-23-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-24-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-25-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-26-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-27-1.pdf}
...
change.
\item[The effect of a small change in productivity on output will depend
on the sector share.]
...
\item[The effect of a large change in productivity on output will also
depend on substitutability.]
...
If perfect complements (\(\sigma=0\)) then
\(\frac{Y'}{Y}=[1-X(1-\lambda^{-1})]^{-1}\).\footnote{Baqaee and Farhi
  (2019) extend Hulten's theorem beyond first-order terms and show that
  second-order terms are often important, e.g.~in calibrations to oil
  shocks .}
...
\subsection{Two Sector CES}\label{two-sector-ces}

See \texttt{posts/2025-12-26-loaves-and-fishes-model-of-ai.qmd}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-28-1.pdf}
...
\includegraphics{2024-08-19-equilibrium-models-of-ai_files/figure-pdf/unnamed-chunk-29-1.pdf}
...
Labor Economics} 42 (2): 591--634. \url{https://doi.org/10.1086/723205}.
...
2023. \url{https://doi.org/10.2139/ssrn.3328877}.
...
Macroeconomics} 7 (3): 95--150. \url{https://doi.org/10.3386/w21165}.

\bibitem[\citeproctext]{ref-caselli2019robot}
Caselli, Francesco, and Alan Manning. 2019. {``Robot Arithmetic: New
Technology and Wages.''} \emph{American Economic Review: Insights} 1
(1): 1--12. \url{https://doi.org/10.1257/aeri.20170036}.
...
arXiv:2309.11690}. \url{https://arxiv.org/pdf/2309.11690.pdf}.
...
Dynamics} 45: 55--82. \url{https://doi.org/10.1016/j.red.2021.05.003}.
...
Economic Research. \url{https://doi.org/10.2139/ssrn.4293620}.
...
61--103. \url{http://www.nber.org/papers/w19136.pdf}.
...
(1): 429--43. \url{https://doi.org/10.1257/000282807780323460}.
...
299--332. \url{https://doi.org/10.2139/ssrn.2658259}.
...
arXiv:2304.02313}. \url{https://arxiv.org/pdf/2304.02313.pdf}.
...
Smith, Noah. 2024. {``Plentiful, High-Paying Jobs in the Age of AI.''}
