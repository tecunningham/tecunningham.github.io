...
(2021), Erdil and Besiroglu (2023), (\textbf{trammell2023economic?}).
...
(\textbf{karabarbounis2014global?}), (\textbf{oberfield2021micro?}) \\
Elasticity of substitution between industries & 0.2 & \(\eta\) &
(\textbf{buera2015skill?}) \\
...
\begin{description}
\tightlist
\item[(\textbf{trammell2023economic?}) ``Economic Growth Under
Transformative AI'' {[}UNFINISHED{]}]
...
& & \\
Labor cost savings in AI-performed tasks & 27\% &
(\textbf{noy2023generative?}) and
(\textbf{brynjolfsson2023generative?}) \\
...
increase by 2\% (i.e.~20\% x 10\%). This is Hulten's theorem
(\textbf{hulten1978growth?}), and holds for small changes in a
competitive economy with constant returns to scale (see derivation in
Acemoglu (2024)).
...
\sidenote{\footnotesize (\textbf{baqaee2019macro?}) extend Hulten's theorem beyond
