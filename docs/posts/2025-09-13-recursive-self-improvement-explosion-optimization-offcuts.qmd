---
title: AI Recursive Self-Improvement OFFCUTS
...
: 
    Historically algorithmic progress has been a function of human R&D, but we now expect the AI to itself increase the rate of algorithmic progress, through increasing effective R&D:
    $$
    \xymatrix@C=1.4em@R=1.4em{
        & *++[F]{\text{R\&D}_t}\ar[d] 
        & *++[F]{\text{R\&D}_{t+1}}\ar[d] 
        & *++[F]{\text{R\&D}_{t+2}}\ar[d]
        & \\
        \ar[r]
        & *++[F]{\text{Algorithms}_t}\ar[r] 
        & *++[F]{\text{Algorithms}_{t+1}}\ar[r]\ar[ur]|{??} 
        & *++[F]{\text{Algorithms}_{t+2}}\ar[r]\ar[ur] & 
    }
    $$
...
1. Some alternatives in how to model this:
...
|                             | annual growth (log) | worker expenditure | experiment expenditure | scale-free? |
| --------------------------- | :-----------------: | :----------------: | :-------------: | :---------: |
| GPU design                  |         0.3         |         -          |        -        |     ✅      |
