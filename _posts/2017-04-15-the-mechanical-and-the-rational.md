...
From having read a lot of this stuff my basic understanding is now this: The generalizations about how animals and humans learn are valid only in specific contexts, they are *not* deep and fundamental laws of behaviour, as had been once believed. The reason the theory is often a good model of decision-making is because it's a good model of the *environment* in which decision-makers typically work. I.e., the theory doesn't tell us much about how the brain works, it tells us mostly about the environment which the brain was designed for.
